...
If you plan to use your own domain name in your configuration, there is one additional thing to take care of: please set up a CNAME entry for the desired subdomain pointing to `catchall.gigantic.io`.
