...
- Activating the [use of similar instance types]({{< relref "/reference/similar-ec2-instance-types" >}}) also increases the likelihood of getting spot instances when using common instance types. Read more about this below.
