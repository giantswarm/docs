...
description: Tutorial on how to create your own admission controller, to enforce certain custom rules and policies in the resources created in your Kubernetes cluster.
weight: 160
menu:
  main:
    parent: advanced
