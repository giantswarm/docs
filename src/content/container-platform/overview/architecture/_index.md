...
menu:
  principal:
    ...
    identifier: container-platform-overview-architecture
user_questions:
...
[Learn how to access the platform API]({{< relref "/container-platform/getting-started/access-to-platform-api" >}}).
...
[Learn more in our guide about GitOps]({{< relref "/container-platform/tutorials/continuous-deployment" >}}).
