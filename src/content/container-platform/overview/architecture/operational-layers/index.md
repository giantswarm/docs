...
menu:
  principal:
    ...
    identifier: container-platform-overview-architecture-operational-layers
...
aliases:
  - /overview/architecture/operational-layers/
...
End users on this level are then created by a Tenant admin either as Service Accounts inside the workload cluster or managed in an [external identity provider (IdP)]({{< relref "/container-platform/overview/architecture/authentication" >}}), like Azure Active Directory or any other OIDC-compliant IdP.
...
- [Securing your Cluster with RBAC]({{< relref "/container-platform/tutorials/security/rbac" >}})
- [Creating a client certificate for workload cluster access]({{< relref "/container-platform/reference/kubectl-gs/login/#workload-cluster-client-certificate" >}})
