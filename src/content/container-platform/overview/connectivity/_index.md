...
menu:
  principal:
    ...
    identifier: container-platform-overview-connectivity
...
Learn how to expose your workloads on Giant Swarm by visiting our [getting started page]({{< relref "/container-platform/getting-started/understand-connectivity/" >}}).
