...
Since the CNI is an important component when bootstrapping a cluster, Cilium is installed ahead of the [Giant Swarm App Platform]({{< relref "/container-platform/overview/fleet-management/app-management" >}}).
