...
menu:
  principal:
    ...
    identifier: container-platform-overview-developer-portal-customizing-labels
...
- [Friendly display of annotations]({{< relref "/container-platform/overview/developer-portal/customizing/annotations" >}})
