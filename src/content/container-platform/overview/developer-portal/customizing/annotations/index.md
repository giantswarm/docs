...
menu:
  principal:
    parent: container-platform-overview-developer-portal-customizing
    identifier: container-platform-overview-developer-portal-customizing-annotations
...
aliases:
  - /overview/developer-portal/customizing/annotations/
---

The use of [labels]({{< relref "/container-platform/overview/developer-portal/customizing/labels" >}}) and annotations on Kubernetes resources like Cluster API clusters is highly individual. With the Giant Swarm developer portal, you can configure which annotations get displayed by default as _friendly annotations_, and how they get displayed. You can customize:

- Order of annotations displayed
- Text displayed for the annotation key

The configuration works mostly like the configuration for [friendly labels]({{< relref "/container-platform/overview/developer-portal/customizing/labels" >}}), with the difference that you cannot configure the color of annotations.
...
- [Friendly display of labels]({{< relref "/container-platform/overview/developer-portal/customizing/labels" >}})
