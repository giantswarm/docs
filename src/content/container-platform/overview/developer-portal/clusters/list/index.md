...
menu:
  principal:
    parent: container-platform-overview-developer-portal-clusters
    identifier: container-platform-overview-developer-portal-clusters-list
...
aliases:
  - /overview/developer-portal/clusters/list/
---
...
- **Name**: Name of the cluster. Click the name to open the [details page]({{< relref "/container-platform/overview/developer-portal/clusters/details" >}}) for this cluster.
...
- For more details about an individual cluster, refer to the [cluster details page]({{< relref "/container-platform/overview/developer-portal/clusters/details" >}}).
