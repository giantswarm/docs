...
menu:
  principal:
    ...
    identifier: container-platform-overview-developer-portal-clusters-details
...
aliases:
  - /overview/developer-portal/clusters/details/
---
...
The panel explains how to access the Kubernetes API of this cluster using `kubectl` and Giant Swarm's plugin [kubectl-gs]({{< relref "/container-platform/reference/kubectl-gs" >}}).
