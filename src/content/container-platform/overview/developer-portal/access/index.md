...
menu:
  principal:
    ...
    identifier: container-platform-overview-developer-portal-access
...
aliases:
  - /overview/developer-portal/access/
---
...
By default, the URL is set to `https://backstage.BASE_DOMAIN/`. However, this URL is customizable to match your company's domain and branding preferences. Find out more in the [customizing the developer portal]({{< relref "/container-platform/overview/developer-portal/customizing/url" >}}) section.
