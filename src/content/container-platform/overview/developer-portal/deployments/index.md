...
menu:
  principal:
    parent: container-platform-overview-developer-portal
    identifier: container-platform-overview-developer-portal-deployments
...
aliases:
  - /overview/developer-portal/deployments/
---
...
The list shows key details about each app deployed to any of your clusters, either via an [App]({{< relref "/container-platform/reference/platform-api/crd/apps.application.giantswarm.io.md" >}}) or a [HelmRelease](https://fluxcd.io/flux/components/helm/helmreleases/) in a management cluster.
