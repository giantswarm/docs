...
menu:
  principal:
    identifier: container-platform-overview-security-secure-access
    parent: container-platform-overview-security
aliases:
  - /overview/security/secure-access/
...
Want to learn more about how the infrastructure works? Check out the [operational layers article]({{< relref "/container-platform/overview/architecture/operational-layers" >}}).

## User access

We expose the Kubernetes API of each workload cluster to you. You can [manage who gets access by connecting your external identity provider]({{< relref "/container-platform/overview/architecture/authentication" >}}) to the Kubernetes API.
