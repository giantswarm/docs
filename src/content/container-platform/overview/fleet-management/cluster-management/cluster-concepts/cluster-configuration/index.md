...
menu:
  principal:
    ...
    identifier: container-platform-overview-fleet-management-cluster-management-cluster-concepts-cluster-configuration
...
aliases:
  - /overview/fleet-management/cluster-management/cluster-concepts/cluster-configuration/
---

Cluster configuration is managed through the [app platform]({{< relref "/container-platform/tutorials/fleet-management/app-platform/app-configuration" >}}) configuration options.
...
The interface to define a workload cluster is built on top of Helm and [the app platform]({{< relref "/container-platform/overview/fleet-management/app-management/" >}}). Creating a cluster means delivering a configured `App` resource to the platform API.
...
Cluster configuration builds on the [app platform configuration levels]({{< relref "/container-platform/tutorials/fleet-management/app-platform/app-configuration/#levels" >}}):
...
To apply this with reusable Kustomize bases, see [creating a base template for your workload cluster]({{< relref "/container-platform/tutorials/continuous-deployment/bases/" >}}).
