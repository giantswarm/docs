...
menu:
  principal:
    ...
    identifier: container-platform-overview-fleet-management-cluster-management-cluster-concepts-releases
user_questions:
...
aliases:
  - /overview/fleet-management/cluster-management/cluster-concepts/releases/
...
- Using the [`kubectl gs get release`]({{< relref "/container-platform/reference/kubectl-gs/get-releases/" >}}) command, you can get more information about the workload cluster releases available in your installation. This command lists all available workload cluster releases, their versions, and the Kubernetes version they contain.
...
- [Cluster upgrades]({{< relref "/container-platform/tutorials/fleet-management/cluster-management/cluster-upgrades" >}}) explains how upgrades work and suggests some best practices to keep a cluster ready to upgrade.
