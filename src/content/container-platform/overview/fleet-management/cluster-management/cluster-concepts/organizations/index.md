...
menu:
  principal:
    ...
    identifier: container-platform-overview-fleet-management-cluster-management-cluster-concepts-organizations
...
aliases:
  - /overview/fleet-management/cluster-management/cluster-concepts/organizations/
---
...
The organization concept makes use of some well-known building blocks of Kubernetes in the [platform API]({{< relref "/container-platform/overview/architecture" >}}), such as:
...
Giant Swarm management clusters provide a CRD named `Organization` (long form: `organizations.security.giantswarm.io`, [schema documentation]({{< relref "/container-platform/reference/platform-api/crd/organizations.security.giantswarm.io.md" >}})). An organization is defined simply by a custom resource using that CRD, which we'll call an "organization CR" here for brevity.
...
The [platform API]({{< relref "/container-platform/reference/platform-api" >}}) provides full, native support for managing all organization-related resources.
