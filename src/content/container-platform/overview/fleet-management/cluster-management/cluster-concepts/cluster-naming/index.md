...
menu:
  principal:
    ...
    identifier: container-platform-overview-fleet-management-cluster-management-cluster-concepts-cluster-naming
...
aliases:
  - /overview/fleet-management/cluster-management/cluster-concepts/cluster-naming/
---
