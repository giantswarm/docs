...
menu:
  principal:
    ...
    identifier: container-platform-overview-fleet-management-cluster-management-installation-name
user_questions:
...
aliases:
  - /overview/fleet-management/cluster-management/installation-name/
---
