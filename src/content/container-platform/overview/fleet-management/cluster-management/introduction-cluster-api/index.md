...
menu:
  principal:
    parent: container-platform-overview-fleet-management-cluster-management
    identifier: container-platform-overview-fleet-management-cluster-management-introduction-cluster-api
aliases:
  - /overview/fleet-management/cluster-management/introduction-cluster-api/
...
On top of the chart, we've got the [`App` concept]({{< relref "/container-platform/overview/fleet-management/app-management" >}}). This is a custom resource that helps us select a chart to install in the management cluster. It adds extended configuration capabilities that enhance the fleet management experience.

Learn more by reading how to [create your first workload cluster]({{< relref "/container-platform/getting-started/provision-your-first-workload-cluster" >}}).
