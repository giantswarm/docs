...
menu:
  principal:
    ...
    identifier: container-platform-overview-fleet-management-multi-tenancy
last_review_date: 2025-09-19
owner:
  - https://github.com/orgs/giantswarm/teams/sig-product
aliases:
  - /overview/fleet-management/multi-tenancy/
...
The organization concept makes use of some well-known building blocks of Kubernetes in the [platform API]({{< relref "/container-platform/overview/architecture#platform-api" >}}), such as:
...
Learn how to control organizations by taking a look at [platform API access page]({{< relref "/container-platform/getting-started/access-to-platform-api/" >}}).
