...
menu:
  principal:
    ...
    identifier: container-platform-overview-continuous-deployment
...
aliases:
  - /overview/continuous-deployment/
---
...
Learn how to start with continuous deployment on Giant Swarm by visiting our [getting started continuous deployment page]({{< relref "/container-platform/getting-started/install-an-application/" >}}).
