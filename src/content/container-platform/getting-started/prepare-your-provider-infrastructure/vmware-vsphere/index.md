...
menu:
  principal:
    identifier: container-platform-getting-started-prepare-your-provider-infrastructure-vmware-vsphere
...
aliases:
  - /getting-started/prepare-your-provider-infrastructure/vmware-vsphere/
...
- Access to internet on port `443` to pull artifacts from our repositories, download CVE databases, pull container images, etc. You can whitelist the domains in this [domain allow list]({{ relref "/container-platform/overview/security/domain-allowlist" }}). Note that we also support authenticated HTTP proxies.
