...
menu:
  principal:
    ...
    identifier: container-platform-getting-started-provision-your-first-workload-cluster
owner:
...
You can template a cluster ([command reference]({{< relref "/container-platform/reference/kubectl-gs/template-cluster" >}})) as follows:
...
The name passed to `aws-cluster-role-identity-name` must match the name of [an existing `AWSClusterRoleIdentity`]({{< relref "/container-platform/getting-started/prepare-your-provider-infrastructure/aws/#configure-cluster-role-identity" >}}).
...
If you would like to protect your clusters from accidental deletion, take a look at our [deletion prevention mechanism]({{< relref "/container-platform/tutorials/fleet-management/deletion-prevention" >}}).

## Next step

Since you know how to provision a workload cluster, now you can deploy [your first app following these steps]({{< relref "/container-platform/getting-started/install-an-application" >}}).
