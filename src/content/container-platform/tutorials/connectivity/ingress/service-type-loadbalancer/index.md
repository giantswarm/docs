...
aliases:
  - /tutorials/connectivity/ingress/service-type-loadbalancer/
...
You can use this to [expose single services](#service-of-type-lb) to the internet. It's also possible, to [install additional ingress-nginx controllers]({{< relref "/container-platform/tutorials/connectivity/ingress/multi-nginx-ic" >}}) to expose a subset of your services with a different ingress controller configuration.
...
- [Running Multiple ingress-nginx controllers]({{< relref "/container-platform/tutorials/connectivity/ingress/multi-nginx-ic" >}})
...
- [Deploying the ingress-nginx controller]({{< relref "/container-platform/getting-started/install-an-application#install-ingress-controller" >}})
