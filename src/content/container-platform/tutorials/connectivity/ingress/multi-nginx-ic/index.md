...
aliases:
  - /tutorials/connectivity/ingress/multi-nginx-ic/
...
It's possible to install multiple ingress controllers in a Kubernetes cluster. The ingress-nginx controller can be [installed as an App on your cluster]({{< relref "/container-platform/getting-started/install-an-application#install-ingress-controller" >}}). Ingress nginx installs an `IngressClass` with the default name `nginx` and controller value `k8s.io/ingress-nginx`.
...
Further information on configuring ingress-nginx controller can be found on the [Advanced ingress configuration]({{< relref "/container-platform/tutorials/connectivity/ingress/configuration/index.md" >}}) page.
...
More information on this topic can be found in the document [Services of type LoadBalancer]({{< relref "/container-platform/tutorials/connectivity/ingress/service-type-loadbalancer" >}}).
...
- [Services of type LoadBalancer]({{< relref "/container-platform/tutorials/connectivity/ingress/service-type-loadbalancer" >}})
- [Installing an ingress controller]({{< relref "/container-platform/getting-started/install-an-application#install-ingress-controller" >}})
