...
menu:
  principal:
    ...
    identifier: container-platform-tutorials-connectivity-coredns
aliases:
  - /tutorials/connectivity/coredns/
...
More information about [cluster configuration]({{< relref "/container-platform/tutorials/fleet-management/app-platform/configuring-default-apps/" >}}).
