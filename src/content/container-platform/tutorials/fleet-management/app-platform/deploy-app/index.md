...
weight: 100
aliases:
  - /tutorials/fleet-management/app-platform/deploy-app/
...
menu:
  principal:
    ...
    identifier: container-platform-tutorials-fleet-management-app-platform-deploy-app
owner:
...
You can access your management cluster using the [`kubectl gs login`]({{< relref "/container-platform/reference/kubectl-gs/login" >}}) command of our kubectl plugin. See [here]({{< relref "/container-platform/reference/kubectl-gs/installation" >}}) for how to install it.
...
You can browse the apps in our catalog using [the developer portal UI]({{< relref "/container-platform/overview/developer-portal/" >}}) but this information is also available in the management cluster in form of resources. The [AppCatalogEntry]({{< relref "/container-platform/reference/platform-api/crd/appcatalogentries.application.giantswarm.io.md" >}}) custom resources show the apps that are available.

First let's list the available [Catalog]({{< relref "/container-platform/reference/platform-api/crd/catalogs.application.giantswarm.io.md" >}}) custom resources.
...
We can use the [`kubectl gs template app`]({{< relref "/container-platform/reference/kubectl-gs/login" >}})
...
The labels, cluster configuration and kubeconfig have been all defaulted to the correct values for your cluster. You can read more about defaulting and validation for App resources [here]({{< relref "/container-platform/tutorials/fleet-management/app-platform/defaulting-validation" >}}).
...
You can read more about app platform configuration [here]({{< relref "/container-platform/tutorials/fleet-management/app-platform/app-configuration" >}}) and about advanced ingress configuration [here]({{< relref "/container-platform/tutorials/connectivity/ingress/configuration" >}}).
