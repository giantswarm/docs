...
menu:
  principal:
    ...
    identifier: container-platform-tutorials-fleet-management-job-management-kuberay
owner:
...
aliases:
  - /tutorials/fleet-management/job-management/kuberay/
---
...
- [Giant Swarm App Platform]({{< relref "/container-platform/tutorials/fleet-management/app-platform" >}})
