...
menu:
  principal:
    parent: container-platform-tutorials-fleet-management-job-management
    identifier: container-platform-tutorials-fleet-management-job-management-kueue
owner:
...
aliases:
  - /tutorials/fleet-management/job-management/kueue/
---
...
You can access [our Observability platform UI]({{< relref "/observability-platform/overview/dashboard-management/dashboard-exploration/" >}}) to get a glance of those metrics.
