...
menu:
  principal:
    identifier: container-platform-tutorials-fleet-management-cluster-management-workload-cluster-api-access-for-automation
...
aliases:
  - /tutorials/fleet-management/cluster-management/workload-cluster-api-access-for-automation/
---
...
1. [Make sure you are logged in the right workload cluster]({{< relref "/container-platform/tutorials/access-management/authentication/user" >}}).
...
Learn how to [access the platform API]({{< relref "/container-platform/tutorials/access-management/authentication/automation" >}}) for your automation.
