...
menu:
  principal:
    identifier: container-platform-tutorials-fleet-management-cluster-management-aws-cilium-eni-mode
...
aliases:
  - /tutorials/fleet-management/cluster-management/aws-cilium-eni-mode/
---
...
First, template a regular cluster (refer to [Creating a workload cluster]({{< relref "/container-platform/getting-started/provision-your-first-workload-cluster/" >}})):
