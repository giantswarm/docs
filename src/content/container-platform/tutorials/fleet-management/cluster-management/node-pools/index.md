...
menu:
  principal:
    identifier: container-platform-tutorials-fleet-management-cluster-management-node-pools
...
Node pools can be created, deleted or updated by changing the configuration used [when creating the cluster]({{< relref "/container-platform/getting-started/provision-your-first-workload-cluster" >}})
