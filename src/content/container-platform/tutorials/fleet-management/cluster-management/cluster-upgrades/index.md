...
menu:
  principal:
    ...
    identifier: container-platform-tutorials-fleet-management-cluster-management-cluster-upgrades
aliases:
  - /tutorials/fleet-management/cluster-management/cluster-upgrades/
...
- **kubectl-gs** command line tool: Use the [`update cluster`]({{< relref "/container-platform/reference/kubectl-gs/update-cluster" >}}) command with the `--release-version` flag
