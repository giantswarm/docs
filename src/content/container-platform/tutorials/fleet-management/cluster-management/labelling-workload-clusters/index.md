...
menu:
  principal:
    ...
    identifier: container-platform-tutorials-fleet-management-cluster-management-labelling-workload-clusters
user_questions:
...
aliases:
  - /tutorials/fleet-management/cluster-management/labelling-workload-clusters/
---
...
For more information, please read the [deletion prevention]({{< relref "/container-platform/tutorials/fleet-management/deletion-prevention" >}}) article.
...
If you use [`kubectl gs template cluster`]({{< relref "/container-platform/reference/kubectl-gs/template-cluster" >}}) to create a cluster manifest, you can apply the `--label` flag with your initial command, as often as required. You are also free to modify the created manifest before applying it. Example:
