...
weight: 20
aliases:
  - /tutorials/fleet-management/cluster-management/aws-cluster-scaling/
  - /vintage/getting-started/sizing-multi-tenancy
menu:
  principal:
    parent: container-platform-tutorials-fleet-management-cluster-management
    identifier: container-platform-tutorials-fleet-management-cluster-management-aws-cluster-scaling
...
You can learn more about the Karpenter configuration in the [node pools configuration page]({{< ref "/container-platform/tutorials/fleet-management/cluster-management/node-pools" >}}).
...
You can learn more about those values in the [cluster autoscaler configuration page]({{< ref "/container-platform/tutorials/fleet-management/cluster-management/cluster-autoscaler" >}}).
