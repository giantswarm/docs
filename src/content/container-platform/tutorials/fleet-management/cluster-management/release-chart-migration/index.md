...
menu:
  principal:
    ...
    identifier: container-platform-tutorials-fleet-management-cluster-management-release-chart-migration
...
aliases:
  - /tutorials/fleet-management/cluster-management/release-chart-migration/
---
...
For new clusters created with release version 35 or later, [`kubectl-gs template cluster`]({{< relref "/container-platform/reference/kubectl-gs/template-cluster" >}}) automatically uses `release-<provider>` chart names. No manual steps are required.
