...
menu:
  principal:
    ...
    identifier: container-platform-tutorials-fleet-management-cluster-management-dynamic-resource-allocation
owner:
...
aliases:
  - /tutorials/fleet-management/cluster-management/dynamic-resource-allocation/
---
...
- GPU nodes configured in your cluster (see [GPU workloads tutorial]({{< relref "/container-platform/tutorials/fleet-management/cluster-management/gpu" >}}))
...
- Learn about [GPU workloads]({{< relref "/container-platform/tutorials/fleet-management/cluster-management/gpu" >}}) for traditional GPU scheduling
- Explore [cluster autoscaling]({{< relref "/container-platform/tutorials/fleet-management/cluster-management/cluster-autoscaler" >}}) for dynamic GPU node provisioning
