...
menu:
  principal:
    parent: container-platform-tutorials-fleet-management-cluster-management
    identifier: container-platform-tutorials-fleet-management-cluster-management-multi-az
...
aliases:
  - /tutorials/fleet-management/cluster-management/multi-az/
---
...
Spreading worker nodes over multiple availability zones can be configured per [node pool]({{< relref "/container-platform/tutorials/fleet-management/cluster-management/node-pools" >}}) and independent of the choice of a single control plane node vs. using multiple control plane nodes (currently multiple control plane nodes are only supported on AWS).
...
You can read [`kubectl gs template cluster`]({{< relref "/container-platform/reference/kubectl-gs/template-cluster" >}}) to learn how to create a cluster with multiple availability zones.
...
Learn more about [node pools]({{< relref "/container-platform/tutorials/fleet-management/cluster-management/node-pools" >}}) and how to manage them.
