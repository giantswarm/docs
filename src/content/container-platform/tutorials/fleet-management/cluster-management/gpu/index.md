...
menu:
  principal:
    ...
    identifier: container-platform-tutorials-fleet-management-cluster-management-gpu
owner:
...
aliases:
  - /tutorials/fleet-management/cluster-management/gpu/
---
...
Giant Swarm offers a [Observability platform]({{< relref "/observability-platform/overview" >}}) ready to use by your workloads. In current case, you can observe the metrics of the GPU devices available in the cluster. In order to feed those metrics into the platform you need to set a `ServiceMonitor` like:
