...
menu:
  principal:
    identifier: container-platform-tutorials-fleet-management-deletion-prevention
    parent: container-platform-tutorials-fleet-management
user_questions:
...
aliases:
  - /tutorials/fleet-management/deletion-prevention/
  ...
  - /tutorials/fleet-management/cluster-management/deletion-prevention
owner:
...
In the `kubectl gs template cluster` command of the [Create a workload cluster]({{< relref "/container-platform/getting-started/provision-your-first-workload-cluster/" >}}) guide, add the parameter `--prevent-deletion`.
...
[Here]({{< relref "/container-platform/tutorials/fleet-management/app-platform/app-configuration/" >}}) you can learn more about how to configure an app.
