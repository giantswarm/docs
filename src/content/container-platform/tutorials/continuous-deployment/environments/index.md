...
menu:
  principal:
    ...
    identifier: container-platform-tutorials-continuous-deployment-environments
user_questions:
...
aliases:
  - /tutorials/continuous-deployment/environments/
---
...
**Warning**: For the sake of simplicity both reference the same base template, but in some occasions where there are breaking changes you might need to link a different template. [Read more about bases here]({{< relref "/container-platform/tutorials/continuous-deployment/bases" >}}).
...
**Note**:  It uses the extra configuration feature of `App` resource to patch additional layers of configurations. [Read more here]({{< relref "/container-platform/tutorials/fleet-management/app-platform/app-configuration/#extra-configs" >}}).
...
Further, [you can find tooling to verify your resources]({{< relref "/container-platform/tutorials/continuous-deployment/tools/" >}}) and ensure that the configuration is correct.
