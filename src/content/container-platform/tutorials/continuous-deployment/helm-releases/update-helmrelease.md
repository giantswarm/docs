...
menu:
  principal:
    identifier: container-platform-tutorials-continuous-deployment-helm-releases-update-helmrelease
...
aliases:
  - /tutorials/continuous-deployment/helm-releases/update-helmrelease/
---
...
For the App CR equivalent of this guide, see [Update an existing App]({{< relref "/container-platform/tutorials/continuous-deployment/apps/update-appcr" >}}).
