...
menu:
  principal:
    identifier: container-platform-tutorials-continuous-deployment-helm-releases-automatic-updates-helmrelease
...
aliases:
  - /tutorials/continuous-deployment/helm-releases/automatic-updates-helmrelease/
---
...
The App CR equivalent of this guide is [Enable automatic updates in Apps]({{< relref "/container-platform/tutorials/continuous-deployment/apps/automatic-updates-appcr" >}}).
