...
menu:
  principal:
    identifier: container-platform-tutorials-continuous-deployment-apps-automatic-updates-appcr
...
aliases:
  - /tutorials/continuous-deployment/apps/automatic-updates-appcr/
---
