...
menu:
  principal:
    ...
    identifier: container-platform-tutorials-continuous-deployment-what-is-gitops
...
aliases:
  - /tutorials/continuous-deployment/what-is-gitops/
---
...
Learn more about our GitOps operator, [`Flux`]({{< relref "/container-platform/tutorials/continuous-deployment/flux/" >}}).
