...
menu:
  principal:
    ...
    identifier: container-platform-tutorials-continuous-deployment-flux
user_questions:
  - What is FluxCD?
owner:
...
aliases:
  - /tutorials/continuous-deployment/flux/
---
...
Luckily, `Flux` is bootstrapped and running in Giant Swarm management clusters, so you can start using it immediately. Browse the [template configuration]({{< relref "/container-platform/tutorials/continuous-deployment/manage-workload-clusters" >}}) to understand how to set up your environment.
...
Learn [`what's a base template`]({{< relref "/container-platform/tutorials/continuous-deployment/bases/" >}}).
