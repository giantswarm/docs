...
menu:
  principal:
    ...
    identifier: container-platform-tutorials-continuous-deployment-gitops-at-giantswarm
user_questions:
...
aliases:
  - /tutorials/continuous-deployment/gitops-at-giantswarm/
---
...
Read the next chapter, [what's GitOps?]({{< relref "/container-platform/tutorials/continuous-deployment/what-is-gitops/" >}}).
