...
menu:
  principal:
    ...
    identifier: container-platform-tutorials-security-tls-certificates
user_questions:
...
aliases:
  - /tutorials/security/tls-certificates/
...
If you want to learn more about [`Ingress` connectivity]({{< relref "/container-platform/tutorials/connectivity/ingress/" >}}), please check our tutorials.
