...
To configure specific parts of the values yourself, start from the application chart at [giantswarm/external-secrets](https://github.com/giantswarm/external-secrets). For the configuration options the app platform offers, see [app configuration]({{< relref "/container-platform/tutorials/fleet-management/app-platform/app-configuration" >}}).
