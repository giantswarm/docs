...
menu:
  principal:
    identifier: container-platform-tutorials-access-management-authentication-user
...
aliases:
  - /tutorials/access-management/authentication/user/
...
Assuming that you want to work with the API using `kubectl`, we recommend you install the [Giant Swarm plug-in]({{< relref "/container-platform/reference/kubectl-gs/_index.md" >}}) named `gs`. It can be [installed]({{< relref "/container-platform/reference/kubectl-gs/installation/index.md" >}}) and updated using `krew`.
...
More information can be found in the [`kubectl gs login`]({{< relref "/container-platform/reference/kubectl-gs/login" >}}) manual page.
...
- [Authentication for programmatic access]({{< relref "/container-platform/tutorials/access-management/authentication/automation" >}}) explains how to authenticate in an automation context
- [Technical details]({{< relref "/container-platform/tutorials/access-management/authentication/additional-details" >}}) on authentication and single sign-on (SSO) for the platform API
