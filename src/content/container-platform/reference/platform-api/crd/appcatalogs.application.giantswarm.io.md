...
crd:
  ...
  topics:
    - apps
  deprecation:
    info: Both AppCatalog and its successor Catalog are being phased out in favor of Flux sources (OCIRepository, HelmRepository). For the timeline and migration path, see &lt;a href=&#34;/container-platform/overview/fleet-management/app-management/app-platform-deprecation/&#34;&gt;App Platform deprecation&lt;/a&gt;.
    replaced_by:
...
aliases:
  - /reference/platform-api/crd/appcatalogs.application.giantswarm.io/
...
Both AppCatalog and its successor Catalog are being phased out in favor of Flux sources (OCIRepository, HelmRepository). For the timeline and migration path, see &lt;a href=&#34;/container-platform/overview/fleet-management/app-management/app-platform-deprecation/&#34;&gt;App Platform deprecation&lt;/a&gt;.
