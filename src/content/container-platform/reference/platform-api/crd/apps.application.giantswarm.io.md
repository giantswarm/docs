...
crd:
  ...
  topics:
    - apps
  deprecation:
    info: Use Flux HelmRelease and OCIRepository for new deployments. The existing App reconciliation continues to work. For the timeline and migration path, see &lt;a href=&#34;/container-platform/overview/fleet-management/app-management/app-platform-deprecation/&#34;&gt;App Platform deprecation&lt;/a&gt;.
layout: crd
owner:
  - https://github.com/orgs/giantswarm/teams/team-honeybadger
aliases:
  - /reference/platform-api/crd/apps.application.giantswarm.io/
...
Use Flux HelmRelease and OCIRepository for new deployments. The existing App reconciliation continues to work. For the timeline and migration path, see &lt;a href=&#34;/container-platform/overview/fleet-management/app-management/app-platform-deprecation/&#34;&gt;App Platform deprecation&lt;/a&gt;.
</p>
...
<div class="property-description">
<p>ConfigMap references a config map containing values that should be applied to the app.</p>
...
<div class="property-description">
<p>Name is the name of the config map containing app values to apply, e.g. prometheus-values.</p>
...
<div class="property-description">
<p>Namespace is the namespace of the values config map, e.g. monitoring.</p>
...
<div class="property-description">
<p>Secret references a secret containing secret values that should be applied to the app.</p>
...
<div class="property-description">
<p>Name is the name of the secret containing app values to apply, e.g. prometheus-secret.</p>
...
<div class="property-description">
<p>KubeConfig is the kubeconfig to connect to the cluster when deploying the app.</p>
...
<div class="property depth-2">
<div class="property-header">
<h3 class="property-path" id="v1alpha1-.spec.kubeConfig.context">.spec.kubeConfig.context</h3>
</div>
<div class="property-body">
<div class="property-meta">
<span class="property-type">object</span>
...
<div class="property depth-3">
<div class="property-header">
<h3 class="property-path" id="v1alpha1-.spec.kubeConfig.context.name">.spec.kubeConfig.context.name</h3>
</div>
<div class="property-body">
<div class="property-meta">
<span class="property-type">string</span>
...
<div class="property depth-2">
<div class="property-header">
<h3 class="property-path" id="v1alpha1-.spec.kubeConfig.inCluster">.spec.kubeConfig.inCluster</h3>
</div>
<div class="property-body">
<div class="property-meta">
<span class="property-type">boolean</span>
...
<div class="property-description">
<p>InCluster is a flag for whether to use InCluster credentials. When true the context name and secret should not be set.</p>
...
<div class="property depth-2">
<div class="property-header">
<h3 class="property-path" id="v1alpha1-.spec.kubeConfig.secret">.spec.kubeConfig.secret</h3>
</div>
<div class="property-body">
<div class="property-meta">
<span class="property-type">object</span>
...
<div class="property depth-3">
<div class="property-header">
<h3 class="property-path" id="v1alpha1-.spec.kubeConfig.secret.name">.spec.kubeConfig.secret.name</h3>
</div>
<div class="property-body">
<div class="property-meta">
<span class="property-type">string</span>
...
<div class="property-description">
<p>Name is the name of the secret containing the kubeconfig, e.g. app-operator-kubeconfig.</p>
...
<div class="property depth-3">
<div class="property-header">
<h3 class="property-path" id="v1alpha1-.spec.kubeConfig.secret.namespace">.spec.kubeConfig.secret.namespace</h3>
</div>
<div class="property-body">
<div class="property-meta">
<span class="property-type">string</span>
...
<div class="property-description">
<p>Namespace is the namespace of the secret containing the kubeconfig, e.g. giantswarm.</p>
...
<div class="property-description">
<p>Name is the name of the app to be deployed. e.g. kubernetes-prometheus</p>
...
<div class="property depth-1">
<div class="property-header">
<h3 class="property-path" id="v1alpha1-.spec.namespace">.spec.namespace</h3>
</div>
<div class="property-body">
<div class="property-meta">
<span class="property-type">string</span>
...
<div class="property depth-1">
<div class="property-header">
<h3 class="property-path" id="v1alpha1-.spec.userConfig">.spec.userConfig</h3>
</div>
<div class="property-body">
<div class="property-meta">
<span class="property-type">object</span>
...
<div class="property depth-2">
<div class="property-header">
<h3 class="property-path" id="v1alpha1-.spec.userConfig.configMap">.spec.userConfig.configMap</h3>
</div>
<div class="property-body">
<div class="property-meta">
<span class="property-type">object</span>
...
<div class="property-description">
<p>ConfigMap references a config map containing user values that should be applied to the app.</p>
...
<div class="property depth-3">
<div class="property-header">
<h3 class="property-path" id="v1alpha1-.spec.userConfig.configMap.name">.spec.userConfig.configMap.name</h3>
</div>
<div class="property-body">
<div class="property-meta">
<span class="property-type">string</span>
...
<div class="property-description">
<p>Name is the name of the config map containing user values to apply, e.g. prometheus-user-values.</p>
...
<div class="property depth-3">
<div class="property-header">
<h3 class="property-path" id="v1alpha1-.spec.userConfig.configMap.namespace">.spec.userConfig.configMap.namespace</h3>
</div>
<div class="property-body">
<div class="property-meta">
<span class="property-type">string</span>
...
<div class="property depth-2">
<div class="property-header">
<h3 class="property-path" id="v1alpha1-.spec.userConfig.secret">.spec.userConfig.secret</h3>
</div>
<div class="property-body">
<div class="property-meta">
<span class="property-type">object</span>
...
<div class="property-description">
<p>Secret references a secret containing user secret values that should be applied to the app.</p>
...
<div class="property depth-3">
<div class="property-header">
<h3 class="property-path" id="v1alpha1-.spec.userConfig.secret.name">.spec.userConfig.secret.name</h3>
</div>
<div class="property-body">
<div class="property-meta">
<span class="property-type">string</span>
...
<div class="property-description">
<p>Name is the name of the secret containing user values to apply, e.g. prometheus-user-secret.</p>
...
<div class="property depth-3">
<div class="property-header">
<h3 class="property-path" id="v1alpha1-.spec.userConfig.secret.namespace">.spec.userConfig.secret.namespace</h3>
</div>
<div class="property-body">
<div class="property-meta">
<span class="property-type">string</span>
...
<div class="property-description">
<p>Version is the version of the app that should be deployed. e.g. 1.0.0</p>
...
<div class="property-description">
<p>Status Spec part of the App resource. Initially, it would be left as empty until the operator successfully reconciles the helm release.</p>
...
<div class="property depth-1">
<div class="property-header">
<h3 class="property-path" id="v1alpha1-.status.appVersion">.status.appVersion</h3>
</div>
<div class="property-body">
<div class="property-meta">
<span class="property-type">string</span>
...
<div class="property-description">
<p>AppVersion is the value of the AppVersion field in the Chart.yaml of the deployed app. This is an optional field with the version of the component being deployed. e.g. 0.21.0. <a href="https://helm.sh/docs/topics/charts/#the-chartyaml-file">https://helm.sh/docs/topics/charts/#the-chartyaml-file</a></p>
...
<div class="property depth-1">
<div class="property-header">
<h3 class="property-path" id="v1alpha1-.status.release">.status.release</h3>
</div>
<div class="property-body">
<div class="property-meta">
<span class="property-type">object</span>
...
<div class="property depth-2">
<div class="property-header">
<h3 class="property-path" id="v1alpha1-.status.release.lastDeployed">.status.release.lastDeployed</h3>
</div>
<div class="property-body">
<div class="property-meta">
<span class="property-type">string</span>
...
<div class="property depth-2">
<div class="property-header">
<h3 class="property-path" id="v1alpha1-.status.release.reason">.status.release.reason</h3>
</div>
<div class="property-body">
<div class="property-meta">
<span class="property-type">string</span>
...
<div class="property-description">
<p>Reason is the description of the last status of helm release when the app is not installed successfully, e.g. deploy resource already exists.</p>
...
<div class="property depth-2">
<div class="property-header">
<h3 class="property-path" id="v1alpha1-.status.release.status">.status.release.status</h3>
</div>
<div class="property-body">
<div class="property-meta">
<span class="property-type">string</span>
...
<div class="property-description">
<p>Status is the status of the deployed app, e.g. DEPLOYED.</p>
...
<div class="property-description">
<p>Version is the value of the Version field in the Chart.yaml of the deployed app. e.g. 1.0.0.</p>
