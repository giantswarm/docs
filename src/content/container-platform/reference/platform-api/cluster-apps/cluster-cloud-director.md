...
menu:
  principal:
    identifier: container-platform-reference-platform-api-cluster-apps-cluster-cloud-director
    parent: container-platform-reference-platform-api-cluster-apps
layout: cluster-app
user_questions:
...
aliases:
  - /reference/platform-api/cluster-apps/cluster-cloud-director/
---
