...
menu:
  principal:
    ...
    identifier: container-platform-reference-kubectl-gs-update-cluster
...
This command's purpose is to modify details of a workload cluster. Currently it allows to upgrade a workload cluster to a newer [release]({{< relref "/container-platform/overview/fleet-management/cluster-management/cluster-concepts/releases" >}}).
...
- [`cluster-upgrades`]({{< relref "/container-platform/overview/fleet-management/cluster-management/cluster-concepts/cluster-upgrades" >}}) - Cluster upgrades.
