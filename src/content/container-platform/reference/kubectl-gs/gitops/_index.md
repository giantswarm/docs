...
menu:
  principal:
    identifier: container-platform-reference-kubectl-gs-gitops
...
aliases:
  ...
  - /vintage/use-the-api/kubectl-gs/gitops/
---
...
[1]: {{< relref "/container-platform/reference/kubectl-gs/gitops/init" >}}
[2]: {{< relref "/container-platform/reference/kubectl-gs/gitops/add-mc" >}}
[3]: {{< relref "/container-platform/reference/kubectl-gs/gitops/add-org" >}}
[4]: {{< relref "/container-platform/reference/kubectl-gs/gitops/add-wc" >}}
[5]: {{< relref "/container-platform/reference/kubectl-gs/gitops/add-app" >}}
[6]: {{< relref "/container-platform/reference/kubectl-gs/gitops/add-update" >}}
[7]: {{< relref "/container-platform/reference/kubectl-gs/gitops/add-enc" >}}
[8]: {{< relref "/container-platform/reference/kubectl-gs/gitops/add-base" >}}
