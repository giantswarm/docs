...
menu:
  principal:
    identifier: container-platform-reference-kubectl-gs-gitops-add-enc
    parent: container-platform-reference-kubectl-gs-gitops
...
aliases:
  ...
  - /vintage/use-the-api/kubectl-gs/gitops/add-enc/
---
...
- Basic structure (see [`init`]({{< relref "/container-platform/reference/kubectl-gs/gitops/init" >}}))
- Management cluster (see [`add management-cluster`]({{< relref "/container-platform/reference/kubectl-gs/gitops/add-mc" >}}))
- Organization (see [`add organization`]({{< relref "/container-platform/reference/kubectl-gs/gitops/add-org" >}}))
- Workload cluster (see [`add workload-cluster`]({{< relref "/container-platform/reference/kubectl-gs/gitops/add-wc" >}}))
- Apps (see [`add app`]({{< relref "/container-platform/reference/kubectl-gs/gitops/add-app" >}}))
...
As stated in the [init command]({{< relref "/container-platform/reference/kubectl-gs/gitops/init" >}}), the `kubectl-gs` does not perform encryption on behalf of the user, hence user is
