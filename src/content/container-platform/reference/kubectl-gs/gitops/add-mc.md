...
menu:
  principal:
    identifier: container-platform-reference-kubectl-gs-gitops-add-mc
...
aliases:
  ...
  - /vintage/use-the-api/kubectl-gs/gitops/add-mc/
---
...
when adding the cluster. When skipped at this point, encryption can still be added later by the [`add encryption`]({{< relref "/container-platform/reference/kubectl-gs/gitops/add-enc" >}})
command.
