...
menu:
  principal:
    identifier: container-platform-reference-kubectl-gs
    parent: container-platform-reference
...
`kubectl-gs` is a CLI and a [kubectl](https://kubernetes.io/docs/reference/kubectl/kubectl/) plugin (invoked as `kubectl gs`) for the Giant Swarm [platform API]({{< relref "/container-platform/reference/platform-api" >}}).
...
Find out more details in our [installation docs]({{< relref "/container-platform/reference/kubectl-gs/installation" >}}).

## Usage data collection

Starting with version 4.3.0, kubectl-gs collects anonymous usage data. [Learn more]({{< relref "/container-platform/reference/kubectl-gs/telemetry" >}}).

## Troubleshooting

Otherwise, your Giant Swarm support staff is available for you in case you run into an issue. Also feel free to check our [frequently asked questions]({{< relref "/container-platform/reference/kubectl-gs/faq.md" >}}) on `kubectl-gs`.
...
[1]: {{< relref "/container-platform/reference/kubectl-gs/login" >}}
[2]: {{< relref "/container-platform/reference/kubectl-gs/get-apps" >}}
[3]: {{< relref "/container-platform/reference/kubectl-gs/get-catalogs" >}}
[4]: {{< relref "/container-platform/reference/kubectl-gs/get-clusters" >}}
[5]: {{< relref "/container-platform/reference/kubectl-gs/get-nodepools" >}}
[7]: {{< relref "/container-platform/reference/kubectl-gs/template-catalog" >}}
[8]: {{< relref "/container-platform/reference/kubectl-gs/template-cluster" >}}
[10]: {{< relref "/container-platform/reference/kubectl-gs/template-organization" >}}
[11]: {{< relref "/container-platform/reference/kubectl-gs/get-releases" >}}
[12]: {{< relref "/container-platform/reference/kubectl-gs/update-app" >}}
[13]: {{< relref "/container-platform/reference/kubectl-gs/update-cluster" >}}
[14]: {{< relref "/container-platform/reference/kubectl-gs/gitops" >}}
[15]: {{< relref "/container-platform/reference/kubectl-gs/get-organizations" >}}
[16]: {{< relref "/container-platform/reference/kubectl-gs/deploy-chart" >}}
