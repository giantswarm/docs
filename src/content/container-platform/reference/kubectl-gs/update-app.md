...
menu:
  principal:
    identifier: container-platform-reference-kubectl-gs-update-app
...
This command helps with updating [App]({{< relref "/container-platform/reference/platform-api/crd/apps.application.giantswarm.io.md" >}}) custom resources.
...
- `--version`: New version to update the app to. The version must exist in the [Catalog]({{< relref "/container-platform/overview/fleet-management/app-management" >}}).
