...
menu:
  principal:
    ...
    identifier: container-platform-reference-gitops-tooling
user_questions:
...
aliases:
  - /reference/gitops-tooling/
---

This page lists the tools for building and validating Flux manifests, with the command to invoke each one and where it comes from. For guidance on which tool to reach for when something breaks, see [tools for your GitOps workflow]({{< relref "/container-platform/tutorials/continuous-deployment/tools/" >}}).
