...
2. Navigate to the newly created directory and use [the kubectl-gs plugin](https://github.com/giantswarm/kubectl-gs) to generate the [App resource](https://docs.giantswarm.io/ui-api/kubectl-gs/template-app/):
