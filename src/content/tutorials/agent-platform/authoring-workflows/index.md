...
menu:
  principal:
    ...
    identifier: tutorials-agent-platform-authoring-workflows
owner:
...
- [Manage MCP servers]({{< relref "/tutorials/agent-platform/managing-mcp-servers" >}}): the servers whose tools your workflow steps call.
- [Meta-tools and discovery]({{< relref "/overview/agent-platform/meta-tools" >}}): how an agent finds and invokes a `workflow_<name>` tool.
- [Troubleshooting]({{< relref "/tutorials/agent-platform/troubleshooting" >}}): when a workflow runs but the agent never picks it.
