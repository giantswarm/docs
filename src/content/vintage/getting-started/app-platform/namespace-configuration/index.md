...
This feature enables you to add labels and annotations to the app's target namespace via its [App CR]({{< relref "/reference/platform-api/crd/apps.application.giantswarm.io.md" >}}).
