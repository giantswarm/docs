...
To enable automatic termination of unhealthy nodes, edit the [`Cluster`]({{< relref "/vintage/use-the-api/management-api/crd/clusters.cluster.x-k8s.io.md" >}}) resource of your cluster using the [Management API]({{< relref "/vintage/use-the-api/management-api" >}}).
...
If you want to disable the feature you must remove the annotation from the [`Cluster`]({{< relref "/vintage/use-the-api/management-api/crd/clusters.cluster.x-k8s.io.md" >}}) custom resource.
