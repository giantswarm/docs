...
**Note**: Giant Swarm clusters do not come with an Ingress Controller pre-installed. See our guide on how to install an Ingress Controller from the Giant Swarm Catalog.
