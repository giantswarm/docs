...
added to your configuration whenever you use the [`gsctl login`]({{< relref "/vintage/use-the-api/gsctl/login" >}})
command with a new endpoint URL. [`gsctl select endpoint`]({{< relref "/vintage/use-the-api/gsctl/select-endpoint" >}})
helps you switch between several endpoints while staying logged in.
[`gsctl list endpoints`]({{< relref "/vintage/use-the-api/gsctl/list-endpoints" >}}) and [`gsctl info`]({{< relref "/vintage/use-the-api/gsctl/info" >}})/) give
...
[`gsctl login`]({{< relref "/vintage/use-the-api/gsctl/login" >}}), an alias for the endpoint is automatically set to
...
[`gsctl info`]({{< relref "/vintage/use-the-api/gsctl/info" >}})/). The command
[`gsctl list endpoints`]({{< relref "/vintage/use-the-api/gsctl/list-endpoints" >}}) will print all available endpoints
and their aliases.

Aliases can be edited manually by editing your
[gsctl configuration file]({{< relref "/vintage/use-the-api/gsctl/configuration-file" >}}). We
...
- [`gsctl delete endpoint`]({{< relref "/vintage/use-the-api/gsctl/delete-endpoint" >}})
