...
The `gsctl update nodepool` command allows modifying a [node pool]({{< relref "/vintage/advanced/cluster-management/node-pools-vintage" >}}), such as editing the scaling range and the name.
