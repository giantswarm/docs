...
[role based access control]({{< relref "/vintage/getting-started/security" >}}) (RBAC) rules
in the cluster.
...
[`gsctl create keypair`]({{< relref "/vintage/use-the-api/gsctl/create-keypair" >}}) and
[`gsctl create kubeconfig`]({{< relref "/vintage/use-the-api/gsctl/create-kubeconfig" >}}). These commands request the
