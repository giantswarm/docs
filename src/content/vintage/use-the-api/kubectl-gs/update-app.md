...
- `--version`: New version to update the app to. The version must exist in the [Catalog]({{< relref "/vintage/platform-overview/app-platform/index.md#what-kind-of-app-catalogs-are-there" >}}).
