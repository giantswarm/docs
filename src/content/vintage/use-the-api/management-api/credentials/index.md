...
Any workload cluster in Giant Swarm belongs to an [organization]({{< relref "/vintage/platform-overview/multi-tenancy" >}}) as encoded in the `giantswarm.io/organization` label of the cluster's [`Cluster`](https://doc.crds.dev/github.com/kubernetes-sigs/cluster-api/cluster.x-k8s.io/Cluster/v1beta1) resource.
