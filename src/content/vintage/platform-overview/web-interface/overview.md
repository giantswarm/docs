...
- [View and manage organizations]({{< relref "/vintage/platform-overview/web-interface/organizations" >}})
- View and manage clusters
- Learn how to get started with your workload clusters by following a guide
- [Add, remove and configure Apps on your clusters]({{< relref "/vintage/platform-overview/web-interface/app-platform" >}})
- [Inspect permissions]({{< relref "/vintage/platform-overview/web-interface/permissions" >}})

## Usage data recording

Learn [what data is recorded for what purpose]({{< relref "/vintage/platform-overview/web-interface/usage-data" >}}) when using the web interface.
