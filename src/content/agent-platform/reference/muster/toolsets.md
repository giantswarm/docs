...
menu:
  principal:
    ...
    identifier: agent-platform-reference-muster-toolsets
owner:
...
`filter_tools` accepts two toolset-related arguments next to its [discovery arguments]({{< relref "/agent-platform/reference/muster/meta-tools" >}}#filter-tools-args):
