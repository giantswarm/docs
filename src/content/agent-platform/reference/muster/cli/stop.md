...
menu:
  principal:
    identifier: agent-platform-reference-muster-cli-stop
...
`stop` accepts the [common flags]({{< relref "/agent-platform/reference/muster" >}}#common-flags).
...
- [`muster start`]({{< relref "/agent-platform/reference/muster/cli/start" >}}) - Start a service or run a workflow.
