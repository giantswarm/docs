...
menu:
  principal:
    identifier: agent-platform-reference-muster-cli-list
...
`list` also accepts the [common flags]({{< relref "/agent-platform/reference/muster" >}}#common-flags), including `--output`.
...
- [`muster get`]({{< relref "/agent-platform/reference/muster/cli/get" >}}) - Get details for a single resource.
- [`muster check`]({{< relref "/agent-platform/reference/muster/cli/check" >}}) - Check that a resource is available.
