...
menu:
  principal:
    identifier: agent-platform-reference-muster-cli-events
...
`events` also accepts the [common flags]({{< relref "/agent-platform/reference/muster" >}}#common-flags).
...
- [Troubleshooting]({{< relref "/agent-platform/tutorials/troubleshooting" >}}) - Diagnose connection problems.
