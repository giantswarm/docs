...
menu:
  principal:
    identifier: agent-platform-reference-muster-cli-create
...
`create` also accepts the [common flags]({{< relref "/agent-platform/reference/muster" >}}#common-flags).
