...
menu:
  principal:
    identifier: agent-platform-reference-muster-cli-agent
...
The aggregator must be running first. Start it with [`muster serve`]({{< relref "/agent-platform/reference/muster/cli/serve" >}}).
...
- [Set up your AI agent]({{< relref "/agent-platform/getting-started/ai-agent-setup" >}}) - Connect an IDE to Muster.
- [`muster serve`]({{< relref "/agent-platform/reference/muster/cli/serve" >}}) - Start the aggregator.
- [`muster auth`]({{< relref "/agent-platform/reference/muster/cli/auth" >}}) - Authenticate to a remote aggregator.
