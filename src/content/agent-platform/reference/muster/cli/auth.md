...
menu:
  principal:
    identifier: agent-platform-reference-muster-cli-auth
...
aliases:
  - /reference/muster/cli/auth/
---

`muster auth` manages authentication to a remote, OAuth-protected aggregator. Use it to log in, check your current identity and token status, and log out. For how OAuth works in Muster, see the [security overview]({{< relref "/agent-platform/overview/security" >}}).
...
- [Access control]({{< relref "/agent-platform/tutorials/access-control" >}}) - How identity maps to cluster permissions.
- [`muster context`]({{< relref "/agent-platform/reference/muster/cli/context" >}}) - Manage the endpoints you authenticate to.
