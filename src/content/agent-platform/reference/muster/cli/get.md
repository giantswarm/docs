...
menu:
  principal:
    identifier: agent-platform-reference-muster-cli-get
...
`get` accepts the [common flags]({{< relref "/agent-platform/reference/muster" >}}#common-flags). Use `--output yaml` or `--output json` to inspect the full resource.
