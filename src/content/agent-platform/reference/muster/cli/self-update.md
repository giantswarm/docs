...
menu:
  principal:
    identifier: agent-platform-reference-muster-cli-self-update
...
aliases:
  - /reference/muster/cli/self-update/
---
...
- [`muster version`]({{< relref "/agent-platform/reference/muster/cli/version" >}}) - Check the current version.
