...
menu:
  principal:
    identifier: agent-platform-reference-muster-cli-context
...
- [`muster auth`]({{< relref "/agent-platform/reference/muster/cli/auth" >}}) - Authenticate to the endpoint behind a context.
