...
menu:
  principal:
    ...
    identifier: agent-platform-tutorials-create-an-agent
owner:
...
- A developer portal with the [Agent Platform section enabled]({{< relref "/agent-platform/tutorials/enable-portal-features" >}}), including the deploy prerequisites.
...
- At least one accepted model configuration on the installation—the form lists the models the platform offers and won't proceed without one. On a fresh installation none is accepted yet; [bring your own model]({{< relref "/agent-platform/tutorials/bring-your-own-model" >}}) first.
...
- Your installation's own presets, if the platform team has [defined any]({{< relref "/agent-platform/tutorials/toolset-presets" >}}), each with its description.
...
- [Agent Platform in the developer portal]({{< relref "/agent-platform/overview/developer-portal" >}}) - The whole section, including sessions and the tool explorer.
- [What's the Agent Platform]({{< relref "/agent-platform/overview/introduction" >}}) - The concepts behind what you just deployed.
