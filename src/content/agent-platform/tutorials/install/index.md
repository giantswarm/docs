...
menu:
  principal:
    ...
    identifier: agent-platform-tutorials-install
owner:
...
aliases:
  - /tutorials/agent-platform/install/
...
This guide is the whole-platform track. If you only want the MCP gateway without the runtime and portal, follow [Self-hosting Muster]({{< relref "/agent-platform/tutorials/self-hosting" >}}) instead.
...
- [Self-hosting Muster]({{< relref "/agent-platform/tutorials/self-hosting" >}}) - The gateway-only track.
- [Agent Platform architecture]({{< relref "/agent-platform/overview/architecture" >}}) - What you just installed.
- [Enable Agent Platform features in Backstage]({{< relref "/agent-platform/tutorials/enable-portal-features" >}}) - The portal side of the configuration.
- [Set up your AI agent]({{< relref "/agent-platform/getting-started/ai-agent-setup" >}}) - Connect your IDE to the new endpoint.
