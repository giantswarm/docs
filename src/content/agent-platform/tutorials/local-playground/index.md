...
menu:
  principal:
    ...
    identifier: agent-platform-tutorials-local-playground
owner:
...
aliases:
  - /tutorials/agent-platform/local-playground/
---
...
- **Create an agent.** Open the portal, sign in, and walk the [create-an-agent flow]({{< relref "/agent-platform/tutorials/create-an-agent" >}}) against your own lab.
...
- The bundled Dex ships static users and throwaway passwords by design. Nothing about the lab's identity setup is production guidance—for the real thing, see [Install the Agent Platform on your own cluster]({{< relref "/agent-platform/tutorials/install" >}}).

## Related

- [What's the Agent Platform]({{< relref "/agent-platform/overview/introduction" >}}) - The concepts the lab makes tangible.
- [Agent Platform architecture]({{< relref "/agent-platform/overview/architecture" >}}) - The topology the lab reproduces.
- [Set up your AI agent]({{< relref "/agent-platform/getting-started/ai-agent-setup" >}}) - The same client setup against a real installation.
