...
menu:
  principal:
    ...
    identifier: agent-platform-tutorials-bring-your-own-model
owner:
...
aliases:
  - /tutorials/agent-platform/bring-your-own-model/
---
...
- For the UI option: a developer portal with the [Agent Platform section enabled]({{< relref "/agent-platform/tutorials/enable-portal-features" >}}), or access to the agent runtime UI at `https://kagent.<installation>.<base domain>`. Both sign you in through your installation's single sign-on.
...
If a firewall or proxy restricts the management cluster's outbound traffic, permit the provider's domain first. The [Agent Platform section of the domain allowlist]({{< relref "/container-platform/overview/security/domain-allowlist#agent-platform" >}}) lists the domain per provider.
...
In the developer portal, the **Models** tab shows the same state with an **Accepted** or **Not accepted** label per model. Once a model is accepted, the installation appears in the create-an-agent flow and the model in its picker. From there, [create and deploy an agent]({{< relref "/agent-platform/tutorials/create-an-agent" >}}) to see the model answer.
...
- [Create and deploy an agent]({{< relref "/agent-platform/tutorials/create-an-agent" >}}) - The flow that needs an accepted model.
- [Agent Platform in the developer portal]({{< relref "/agent-platform/overview/developer-portal" >}}) - The section the Models tab belongs to.
- [Enable Agent Platform features in Backstage]({{< relref "/agent-platform/tutorials/enable-portal-features" >}}) - Turning the section on in your portal instance.
- [Install the Agent Platform on your own cluster]({{< relref "/agent-platform/tutorials/install" >}}) - Where the same model configurations live when you run the platform yourself.
