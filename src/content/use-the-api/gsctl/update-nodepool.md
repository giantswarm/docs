...
The `gsctl update nodepool` command allows modifying a [node pool]({{< relref "/advanced/cluster-management/node-pools" >}}), such as editing the scaling range and the name.
