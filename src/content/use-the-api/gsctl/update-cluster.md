...
- [`gsctl create cluster`]({{< relref "/use-the-api/gsctl/create-cluster" >}}) - Add a node pool to a cluster
- [`gsctl list clusters`]({{< relref "/use-the-api/gsctl/list-clusters" >}}) - List all node pools of a cluster
