...
### Notice: This document describes how to configure cloud provider credentials for _vintage_ Giant Swarm Clusters. For _CAPI_ Clusters, documentation is available for [CAPA](https://docs.giantswarm.io/getting-started/cloud-provider-accounts/cluster-api/aws/) and [CAPZ](https://docs.giantswarm.io/getting-started/cloud-provider-accounts/cluster-api/azure/)
