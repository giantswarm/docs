...
Starting from version {{% first_aws_nodepools_version %}} on AWS, Giant Swarm introduced a feature to create multiple [node pools]({{< relref "/advanced/cluster-management/node-pools-vintage" >}}) on AWS.
