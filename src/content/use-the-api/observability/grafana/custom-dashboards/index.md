...
As explained in our guide explaining [how to access Grafana]({{< relref "/use-the-api/observability/grafana/access" >}}), we provide a subset of dashboards accessible by our customers.
