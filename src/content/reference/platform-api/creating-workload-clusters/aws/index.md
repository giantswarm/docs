---
linkTitle: AWS
title: Creating workload clusters on AWS via the Platform API
...
menu:
  main:
    identifier: reference-platform-api-creatingclusters-aws
...
user_questions:
  - How can I create an AWS cluster via the Platform API?
owner:
...
At a high-level, the Platform API is used to manage the following custom resources (CRs):
