...
menu:
  main:
    identifier: reference-platform-api-authentication-user
    parent: reference-platform-api-authentication
last_review_date: 2024-10-17
aliases:
  - /use-the-api/management-api/authentication/user
...
- the Platform API endpoint URL (normally starting with `https://g8s.`) or
...
- [Technical details]({{< relref "/vintage/use-the-api/management-api/authentication/additional-details" >}}) on authentication and single sign-on (SSO) for the Platform API
