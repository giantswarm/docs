...
crd:
  ...
  topics:
    - apps
  deprecation:
    info: Use Flux sources (OCIRepository or HelmRepository) for new deployments. The existing reconciliation continues to work. For the timeline and migration path, see &lt;a href=&#34;/overview/fleet-management/app-management/app-platform-deprecation/&#34;&gt;App Platform deprecation&lt;/a&gt;.
layout: crd
owner:
...
Use Flux sources (OCIRepository or HelmRepository) for new deployments. The existing reconciliation continues to work. For the timeline and migration path, see &lt;a href=&#34;/overview/fleet-management/app-management/app-platform-deprecation/&#34;&gt;App Platform deprecation&lt;/a&gt;.
</p>
