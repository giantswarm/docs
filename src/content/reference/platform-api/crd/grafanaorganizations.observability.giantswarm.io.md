...
weight: 100
crd:
  name_camelcase: GrafanaOrganization
  name_plural: grafanaorganizations
  name_singular: grafanaorganization
...
<p class="crd-description">GrafanaOrganization is the Schema describing a Grafana organization. Its lifecycle is managed by the observability-operator.</p>
<dl class="crd-meta">
<dt class="fullname">Full name:</dt>
<dd class="fullname">grafanaorganizations.observability.giantswarm.io</dd>
<dt class="groupname">Group:</dt>
<dd class="groupname">observability.giantswarm.io</dd>
<dt class="singularname">Singular name:</dt>
<dd class="singularname">grafanaorganization</dd>
<dt class="pluralname">Plural name:</dt>
<dd class="pluralname">grafanaorganizations</dd>
...
<div class="property-header">
<h3 class="property-path" id="v1alpha1-.spec.displayName">.spec.displayName</h3>
</div>
<div class="property-body">
<div class="property-meta">
<span class="property-type">string</span>
...
<div class="property depth-1">
<div class="property-header">
<h3 class="property-path" id="v1alpha1-.spec.rbac">.spec.rbac</h3>
</div>
<div class="property-body">
<div class="property-meta">
<span class="property-type">object</span>
...
<div class="property-header">
<h3 class="property-path" id="v1alpha1-.spec.rbac.admins">.spec.rbac.admins</h3>
</div>
<div class="property-body">
<div class="property-meta">
...
<div class="property depth-2">
<div class="property-header">
<h3 class="property-path" id="v1alpha1-.spec.rbac.editors">.spec.rbac.editors</h3>
</div>
<div class="property-body">
<div class="property-meta">
<span class="property-type">array</span>
...
<div class="property depth-2">
<div class="property-header">
<h3 class="property-path" id="v1alpha1-.spec.rbac.viewers">.spec.rbac.viewers</h3>
</div>
<div class="property-body">
<div class="property-meta">
<span class="property-type">array</span>
...
<div class="property depth-1">
<div class="property-header">
<h3 class="property-path" id="v1alpha1-.spec.tenants">.spec.tenants</h3>
</div>
<div class="property-body">
<div class="property-meta">
<span class="property-type">array</span>
...
<div class="property-description">
<p>TenantID is a unique identifier for a tenant. It must be lowercase.</p>
...
<div class="property depth-1">
<div class="property-header">
<h3 class="property-path" id="v1alpha1-.status.dataSources">.status.dataSources</h3>
</div>
<div class="property-body">
<div class="property-meta">
<span class="property-type">array</span>
...
<div class="property depth-3">
<div class="property-header">
<h3 class="property-path" id="v1alpha1-.status.dataSources[*].ID">.status.dataSources[*].ID</h3>
</div>
<div class="property-body">
<div class="property-meta">
...
<div class="property depth-3">
<div class="property-header">
<h3 class="property-path" id="v1alpha1-.status.dataSources[*].name">.status.dataSources[*].name</h3>
</div>
<div class="property-body">
<div class="property-meta">
<span class="property-type">string</span>
