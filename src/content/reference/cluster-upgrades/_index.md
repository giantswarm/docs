...
From release `12.7.0` some of the parameters of the upgrade can be configured. Check [Fine-tuning upgrade disruption on AWS](https://docs.giantswarm.io/guides/fine-tuning-upgrade-distruption-on-aws/) guide for more details.
