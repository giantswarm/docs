...
To configure spot instances in your node pool you can set a base capacity of on-demand instances and then a percentage of spot instances used in the node pool:
