...
![On Premises Tenant Cluster Architecture](/img/architecture-onprem-guest-cluster.png)
...
Access to the K8s API goes through the Control Plane. We can connected your Load Balancer for Ingress access. This Load Balancer can be either statically configured with healthchecks or controlled via API. Depending on the data center setup, there are different options that need to be evaluated.
