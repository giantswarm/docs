...
Under the hood, workload cluster labels are Kubernetes labels attached to [`Cluster`](/reference/management-cluster-api/clusters.cluster.x-k8s.io/) (`clusters.cluster.x-k8s.io`) resources.
Therefore, all means of listing workload cluster labels will return all Kubernetes labels attached to [`Cluster`](/reference/management-cluster-api/clusters.cluster.x-k8s.io/) resources requested.
...
The underlying resource to operate on is [`clusters.cluster.x-k8s.io`](/reference/management-cluster-api/clusters.cluster.x-k8s.io/) from the upstream [cluster-api](https://cluster-api.sigs.k8s.io/) project.
