...
In contrast to the previous step, this is not done in the workload cluster, but in the management cluster instead. So this step requires write access to the [Management Cluster API](/basics/api/#management-cluster-api). Please contact your Giant Swarm Solution Engineer in case you need assistance.
