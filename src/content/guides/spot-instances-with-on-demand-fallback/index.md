...
In contrast to the previous step, this is not done in the workload cluster, but in the control plane instead. So this step requires write access to the [Control Plane Kubernetes API](/basics/api/#cp-k8s-api). Please contact your Giant Swarm Solution Engineer in case you need assistance.
