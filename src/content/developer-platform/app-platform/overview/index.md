...
[app configuration]({{< relref "/developer-platform/app-platform/app-configuration" >}}) which you can override to meet your needs.
...
[installation configuration]({{< relref "/developer-platform/app-platform/installation-configuration" >}}).
...
We provide two _App Catalogs_, the Giant Swarm Catalog and the Giant Swarm Playground. You are able to set up your own [additional catalog(s)]({{< relref "/developer-platform/app-platform/create-catalog" >}})
...
on a specific workload cluster. We [default]({{< relref "/developer-platform/app-platform/defaulting-validation" >}})
