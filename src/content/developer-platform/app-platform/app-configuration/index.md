...
Giant Swarm's [App Platform]({{< relref "/developer-platform/app-platform" >}}) allows you to easily install Apps across your entire
...
looking like the desired state. More information is available in our [general overview of the App Platform]({{< relref "/developer-platform/app-platform" >}}).
