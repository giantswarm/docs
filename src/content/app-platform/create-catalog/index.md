...
Each app catalog has its own [<span class="x x-first x-last">`</span>Catalog<span class="x x-first x-last">`</span>]({{&lt; relref "/ui-api/management-api/crd/catalogs.application.giantswarm.io.md" &gt;}})
