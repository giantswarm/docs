...
menu:
  principal:
    ...
    identifier: observability-platform-overview-dashboard-management-dashboard-creation
...
aliases:
  - /overview/observability/dashboard-management/dashboard-creation/
...
The `observability.giantswarm.io/organization` annotation determines which [Grafana organization]({{< relref "/observability-platform/overview/configuration/creating-grafana-organization" >}}) receives the dashboard. The value must match an existing organization's display name.
...
1. [Access your Grafana instance]({{< relref "/observability-platform/overview/data-management/data-exploration" >}})
...
Before building dashboards, spend time in [Grafana's Explore view]({{< relref "/observability-platform/overview/data-management/data-exploration#how-to-use-explore-and-drilldown-in-grafana" >}}) to understand your data and refine your queries.
...
- **[Set up multi-tenancy]({{< relref "/observability-platform/overview/configuration/multi-tenancy" >}})**: organize dashboards by team or environment
- **[Configure data ingestion]({{< relref "/observability-platform/overview/data-management/data-ingestion" >}})**: ensure you have the right data flowing into your dashboards
