...
menu:
  principal:
    ...
    identifier: observability-platform-overview-dashboard-management-prebuilt-dashboards
...
aliases:
  - /overview/observability/dashboard-management/prebuilt-dashboards/
---
...
To learn how to find and navigate these dashboards in Grafana, see the [dashboard exploration guide]({{< relref "/observability-platform/overview/dashboard-management/dashboard-exploration" >}}).
...
- [Dashboard exploration]({{< relref "/observability-platform/overview/dashboard-management/dashboard-exploration" >}}): how to find, search, and navigate dashboards in Grafana
- [Dashboard creation]({{< relref "/observability-platform/overview/dashboard-management/dashboard-creation" >}}): how to build your own custom dashboards
