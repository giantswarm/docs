...
menu:
  principal:
    ...
    identifier: observability-platform-overview-configuration-multi-tenancy
...
aliases:
  - /overview/observability/configuration/multi-tenancy/
---
...
1. Define the tenant in `GrafanaOrganization` resource (see [documentation]({{< relref "/observability-platform/overview/configuration/creating-grafana-organization" >}}))
2. Configure data collection to use tenant label (see [Data Ingestion documentation]({{< relref "/observability-platform/overview/data-management/data-ingestion" >}}))
3. Verify data appears in organization dashboards (see [Data Exploration documentation]({{< relref "/observability-platform/overview/data-management/data-exploration/" >}}))
...
- [Create a Grafana organization]({{< relref "/observability-platform/overview/configuration/creating-grafana-organization" >}}) to implement your tenant strategy
- [Configure alert management]({{< relref "/observability-platform/overview/alert-management" >}}) with tenant-specific rules
- [Set up data ingestion]({{< relref "/observability-platform/overview/data-management/data-ingestion" >}}) to send data to your tenants
- [Explore your data]({{< relref "/observability-platform/overview/data-management/data-exploration/" >}}) using Grafana dashboards and queries
