...
menu:
  principal:
    identifier: observability-platform-overview-configuration-creating-grafana-organization
...
aliases:
  - /overview/observability/configuration/creating-grafana-organization/
...
This guide walks you through creating and configuring Grafana organizations to implement [multi-tenancy]({{< relref "/observability-platform/overview/configuration/multi-tenancy" >}}) in your observability platform.

## Prerequisites

Before creating your organization, make sure you have:

- [Access to the management cluster]({{< relref "/container-platform/tutorials/access-management" >}}), where you can create custom resources
- Identified the [tenant names]({{< relref "/observability-platform/overview/configuration/multi-tenancy#tenant-naming-best-practices" >}}) you want to use
...
Your organizations will appear alongside the `Shared Org` in the organization dropdown. Learn more about these in our [multi-tenancy overview]({{< relref "/observability-platform/overview/configuration/multi-tenancy#default-organizations" >}}).
...
If you have existing `v1alpha1` organizations, see [migrate Grafana organizations to v1alpha2]({{< relref "/observability-platform/overview/configuration/migrate-grafana-organizations" >}}) for the differences between the versions, conversion examples, and migration best practices. New resources should use `v1alpha2` directly.
...
2. [**Log in to Grafana**]({{< relref "/observability-platform/overview/data-management/data-exploration/" >}}) and verify:
...
- You can [explore and query data]({{< relref "/observability-platform/overview/data-management/data-exploration/" >}}) for each of your tenants
