...
menu:
  principal:
    parent: observability-platform-overview-configuration
    identifier: observability-platform-overview-configuration-introduction
...
aliases:
  - /overview/observability/configuration/introduction/
---
...
[Multi-tenancy configuration]({{< relref "/observability-platform/overview/configuration/multi-tenancy" >}}) affects all other platform components, making it essential to understand before configuring other areas.

### Organization management

Manage your observability platform's organizational structure through **[`GrafanaOrganization`]({{< relref "/observability-platform/overview/configuration/creating-grafana-organization" >}})** resources. Organization management enables you to:
...
Configure **[metrics ingestion]({{< relref "/observability-platform/overview/data-management/data-ingestion/#metrics-ingestion" >}})** to collect custom application and infrastructure metrics:
...
Configure **[log ingestion]({{< relref "/observability-platform/overview/data-management/data-ingestion/#logs-ingestion" >}})** to capture application and system logs:
...
Integrate data from sources outside Giant Swarm managed clusters through our **[Data Import and Export capabilities]({{< relref "/observability-platform/overview/data-management/data-import-export" >}})**:

- **External ingestion**: Send metrics, logs, and traces from external sources using **[authenticated endpoints]({{< relref "/observability-platform/overview/data-management/data-import-export/import#grafana-alloy-configuration-recommended" >}})**
...
**[Create custom dashboards]({{< relref "/observability-platform/overview/dashboard-management/dashboard-creation" >}})** tailored to your specific monitoring needs:
...
**[Create alerting and recording rules]({{< relref "/observability-platform/overview/alert-management/alert-rules" >}})** for proactive monitoring:
...
**[Configure Alertmanager]({{< relref "/observability-platform/overview/alert-management/alert-routing" >}})** for comprehensive alert handling and operational workflows:
...
1. **[Understand multi-tenancy]({{< relref "/observability-platform/overview/configuration/multi-tenancy" >}})**: Work with your Giant Swarm account engineer to plan your data organization strategy
2. **Set up [Grafana organizations]({{< relref "/observability-platform/overview/configuration/creating-grafana-organization" >}})**: Create organizations for your teams with assistance from Giant Swarm
3. **Configure data ingestion**: Set up [metrics]({{< relref "/observability-platform/overview/data-management/data-ingestion/#metrics-ingestion" >}}) and [log collection]({{< relref "/observability-platform/overview/data-management/data-ingestion/#logs-ingestion" >}}) for your applications
4. **Create essential alerts**: Implement [basic alerting rules]({{< relref "/observability-platform/overview/alert-management/alert-rules" >}}) for critical system health
5. **Build dashboards**: Create [custom dashboards]({{< relref "/observability-platform/overview/dashboard-management/dashboard-creation" >}}) for your specific monitoring needs
