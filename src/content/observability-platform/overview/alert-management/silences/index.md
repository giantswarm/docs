...
menu:
  principal:
    ...
    identifier: observability-platform-overview-alert-management-silences
...
aliases:
  - /overview/observability/alert-management/silences/
---

This guide shows you how to create and manage alert silences to temporarily suppress notifications during planned maintenance or while investigating issues. For what silences are, when to use them, and how they fit into the alerting pipeline, see [understanding alert silences]({{< relref "/observability-platform/overview/alert-management/understanding-silences" >}}).
...
1. **Access Grafana**: Navigate to your [installation's Grafana]({{< relref "/observability-platform/getting-started/observe-your-clusters-and-apps/" >}}) interface
...
- Learn about [alert routing]({{< relref "/observability-platform/overview/alert-management/alert-routing/" >}}) to understand how silences integrate with notification workflows
- Review [alert rules]({{< relref "/observability-platform/overview/alert-management/alert-rules/" >}}) to understand what you're silencing
- Explore the [alert management overview]({{< relref "/observability-platform/overview/alert-management/" >}}) for the complete alerting pipeline

## Related observability features

Silence management works best when integrated with other platform capabilities:

- **[Multi-tenancy]({{< relref "/observability-platform/overview/configuration/multi-tenancy/" >}})**: Essential for understanding tenant labeling requirements and secure silence isolation
- **[Alert rules]({{< relref "/observability-platform/overview/alert-management/alert-rules/" >}})**: Understanding your alert rules helps create effective silences
- **[Data exploration]({{< relref "/observability-platform/overview/data-management/data-exploration/" >}})**: Use Grafana Explore to test alert matchers before creating silences
