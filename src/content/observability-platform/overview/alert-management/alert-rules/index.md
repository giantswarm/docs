...
menu:
  principal:
    parent: observability-platform-overview-alert-management
    identifier: observability-platform-overview-alert-management-alert-rules
...
aliases:
  - /overview/observability/alert-management/alert-rules/
  - /tutorials/observability/alerting/create-rules/
---

This guide shows you how to create and deploy alerting and recording rules using Kubernetes resources. For an overview of what these rules are and how they fit into the alerting pipeline, see the [alert management overview]({{< relref "/observability-platform/overview/alert-management/" >}}).
...
The platform evaluates your rules and routes alerts through the [alerting pipeline]({{< relref "/observability-platform/overview/alert-management/" >}}) to configured receivers.
...
Get familiar with tenant management in our [multi-tenancy documentation]({{< relref "/observability-platform/overview/configuration/multi-tenancy/" >}}).
...
- Configure [alert routing]({{< relref "/observability-platform/overview/alert-management/alert-routing/" >}}) for your tenants to complete the alerting pipeline
- Review the [alerting pipeline]({{< relref "/observability-platform/overview/alert-management/" >}}) architecture to understand how alerts flow through the system
- Learn about [data exploration]({{< relref "/observability-platform/overview/data-management/data-exploration/" >}}) to query and analyze the logs, metrics, and traces that drive your alerts

## Related observability features

Alert rules work best when integrated with other platform capabilities:

- **[Data management]({{< relref "/observability-platform/overview/data-management/" >}})**: Use advanced querying techniques to test and refine your alert expressions before deploying them
- **[Multi-tenancy]({{< relref "/observability-platform/overview/configuration/multi-tenancy/" >}})**: Essential for understanding tenant labeling requirements and secure alert isolation
- **[Data Import and Export]({{< relref "/observability-platform/overview/data-management/data-import-export/" >}})**: Import external logs that can trigger alerts and export alert data for comprehensive monitoring coverage across your infrastructure
