...
menu:
  principal:
    ...
    identifier: observability-platform-overview-data-management-data-import-export-observability-platform-api
...
aliases:
  - /overview/observability/data-management/data-import-export/observability-platform-api/
---

This page documents the interface of the Giant Swarm Observability Platform API. It covers the import and export endpoints, the authentication headers, the tenant values you can target, and the settings common OIDC providers need. For task-oriented steps, see [import data]({{< relref "/observability-platform/overview/data-management/data-import-export/import" >}}) and [export data]({{< relref "/observability-platform/overview/data-management/data-import-export/export" >}}).
...
Your identity must have access to the specified tenant, and the tenant must exist in a [Grafana Organization]({{< relref "/observability-platform/overview/configuration/multi-tenancy/" >}}). Requests that target a tenant which doesn't exist are rejected.
...
When you configure a client (for example [Grafana Alloy]({{< relref "/observability-platform/overview/data-management/data-import-export/import#grafana-alloy-configuration-recommended" >}})), set the `token_url` and `scopes` to match your OIDC provider:
...
- [Import data]({{< relref "/observability-platform/overview/data-management/data-import-export/import" >}}): send external data into the platform.
...
- [Data import and export]({{< relref "/observability-platform/overview/data-management/data-import-export" >}}): the concepts behind the API.
