...
menu:
  principal:
    ...
    identifier: observability-platform-overview-data-management-data-transformation-understanding-trace-derived-metrics
...
- [Trace-derived metrics reference]({{< relref "/observability-platform/overview/data-management/data-transformation/trace-derived-metrics" >}}): the metric catalog and query patterns
- [Alert on trace-derived metrics]({{< relref "/observability-platform/overview/data-management/data-transformation/alert-on-trace-derived-metrics" >}}): turn these signals into alerts
- [Service graphs]({{< relref "/observability-platform/overview/data-management/data-exploration/service-graphs/" >}}): the visual topology behind service graph metrics
