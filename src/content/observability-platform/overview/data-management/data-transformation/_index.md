...
menu:
  principal:
    ...
    identifier: observability-platform-overview-data-management-data-transformation
...
aliases:
  - /overview/observability/data-management/data-transformation/
---
...
- **[Recording rules]({{< relref "/observability-platform/overview/alert-management/alert-rules#recording-rules" >}})**: Pre-compute complex PromQL expressions as new time series
...
Recording rules are created using the same `PrometheusRule` resources as alerting rules and are covered in detail in our [alert rules documentation]({{< relref "/observability-platform/overview/alert-management/alert-rules#recording-rules" >}}).
...
For comprehensive guidance on creating and managing recording rules, including examples and best practices, see the [recording rules section]({{< relref "/observability-platform/overview/alert-management/alert-rules#recording-rules" >}}) in our alert rules documentation.
...
For advanced LogQL techniques, see the [LogQL query reference]({{< relref "/observability-platform/overview/data-management/data-exploration/logql" >}}).
...
- Learn how to [create effective dashboards]({{< relref "/observability-platform/overview/dashboard-management/dashboard-creation" >}}) with your transformed data
- Set up [alerting rules]({{< relref "/observability-platform/overview/alert-management/alert-rules" >}}) using recording rules for better performance
