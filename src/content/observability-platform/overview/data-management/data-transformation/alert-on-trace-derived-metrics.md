...
menu:
  principal:
    ...
    identifier: observability-platform-overview-data-management-data-transformation-alert-on-trace-derived-metrics
...
aliases:
  - /overview/observability/data-management/data-transformation/alert-on-trace-derived-metrics/
---

This guide shows you how to build alert rules from [trace-derived metrics]({{< relref "/observability-platform/overview/data-management/data-transformation/trace-derived-metrics" >}}). Because these are ordinary Prometheus metrics, you alert on them exactly as you would any other metric — see the [alert rules guide]({{< relref "/observability-platform/overview/alert-management/alert-rules/" >}}) for how rules are defined and deployed on the platform. The examples below are the trace-specific expressions to drop into that workflow.
...
- [Trace-derived metrics reference]({{< relref "/observability-platform/overview/data-management/data-transformation/trace-derived-metrics" >}}): the metrics and queries these alerts build on
- [Understanding trace-derived metrics]({{< relref "/observability-platform/overview/data-management/data-transformation/understanding-trace-derived-metrics" >}}): why these signals exist and what RED means
- [Alert rules]({{< relref "/observability-platform/overview/alert-management/alert-rules/" >}}): how alert rules are defined and deployed on the platform
- [Dashboard creation]({{< relref "/observability-platform/overview/dashboard-management/dashboard-creation/" >}}): visualize trace metrics alongside other observability data
