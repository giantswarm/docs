...
menu:
  principal:
    ...
    identifier: observability-platform-overview-data-management-data-ingestion-otlp-reference
...
aliases:
  - /overview/observability/data-management/data-ingestion/otlp-reference/
---
...
For the task-oriented steps to configure an application to send data, see the [data ingestion guide]({{< relref "/observability-platform/overview/data-management/data-ingestion" >}}).
...
OTLP data is routed to a [tenant]({{< relref "/observability-platform/overview/configuration/multi-tenancy" >}}) using one of two mechanisms:
...
- [Data ingestion]({{< relref "/observability-platform/overview/data-management/data-ingestion" >}}): how to configure applications to send metrics, logs, and traces
