...
menu:
  principal:
    ...
    identifier: observability-platform-overview-data-management-data-exploration-troubleshoot-traces-with-traceql
...
See the [PromQL query reference]({{< relref "/observability-platform/overview/data-management/data-exploration/promql" >}}) and [LogQL query reference]({{< relref "/observability-platform/overview/data-management/data-exploration/logql" >}}) for the corresponding query patterns.
...
- [TraceQL query reference]({{< relref "/observability-platform/overview/data-management/data-exploration/traceql" >}}): syntax and the full query catalog
...
- [Dashboard creation]({{< relref "/observability-platform/overview/dashboard-management/dashboard-creation" >}}): build custom trace visualizations
