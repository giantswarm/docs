...
menu:
  principal:
    parent: observability-platform-overview-data-management-data-exploration
    identifier: observability-platform-overview-data-management-data-exploration-promql
last_review_date: 2025-07-17
aliases:
  - /overview/observability/data-management/data-exploration/promql/
...
To open Grafana Explore and select a Prometheus data source, see the [data exploration guide]({{< relref "/observability-platform/overview/data-management/data-exploration/" >}}). For the concepts behind these queries — how to approach query construction, the Giant Swarm label model, and service level indicators — see [metrics monitoring concepts]({{< relref "/observability-platform/overview/data-management/data-exploration/metrics-monitoring-concepts" >}}). For the complete language specification, see the [official Prometheus PromQL documentation](https://prometheus.io/docs/prometheus/latest/querying/basics/).
...
These queries express Service Level Indicators (SLIs) and error budgets. For what SLIs, SLOs, and error budgets mean and how to choose them, see [metrics monitoring concepts]({{< relref "/observability-platform/overview/data-management/data-exploration/metrics-monitoring-concepts" >}}).
...
Learn more about [recording rules]({{< relref "/observability-platform/overview/alert-management/alert-rules/" >}})
and [aggregation operators](https://prometheus.io/docs/prometheus/latest/querying/operators/#aggregation-operators).

## See also

- [Metrics monitoring concepts]({{< relref "/observability-platform/overview/data-management/data-exploration/metrics-monitoring-concepts" >}}): query construction methodology, the label model, and SLIs/SLOs
- [Data exploration]({{< relref "/observability-platform/overview/data-management/data-exploration" >}}): how to access Grafana and select a Prometheus data source
- [Dashboard creation]({{< relref "/observability-platform/overview/dashboard-management/dashboard-creation" >}}): visualize your PromQL queries in dashboards
- [Alerting rules]({{< relref "/observability-platform/overview/alert-management/alert-rules/" >}}): turn these queries into proactive alerts
