...
description: Learn how to explore and analyze your observability data using Grafana, PromQL, LogQL, and TraceQL.
weight: 10
menu:
  principal:
    parent: observability-platform-overview-data-management
    identifier: observability-platform-overview-data-management-data-exploration
last_review_date: 2025-07-17
owner:
  - https://github.com/orgs/giantswarm/teams/team-atlas
user_questions:
  - How do I explore observability data?
  - What tools can I use to analyze metrics, logs, and traces?
  - How do I use PromQL, LogQL, and TraceQL?
  - How do I access Grafana Explore?
aliases:
  - /overview/observability/data-management/data-exploration/
  - /tutorials/observability/data-exploration/accessing-grafana/
---

This guide shows you how to use the Explore and Drilldown features in Grafana to query and analyze the metrics, logs, and traces collected by the Giant Swarm Observability Platform. It also explains how to authenticate and access your Grafana instance securely.

Giant Swarm provides an Observability Platform in each installation, based on [Grafana Mimir](https://grafana.com/oss/mimir/) for metrics, [Grafana Loki](https://grafana.com/oss/loki/) for logs, and [Grafana Tempo](https://grafana.com/oss/tempo/) for traces. The platform collects data from the system and apps managed by Giant Swarm, as well as any source of data you configure according to [the data ingestion tutorial]({{< relref "/observability-platform/overview/data-management/data-ingestion" >}}).
...
2. **Log in with single sign-on (SSO):**
   - Access to Grafana is controlled via SSO, using the same identity provider you use for the [platform API]({{< relref "/container-platform/tutorials/access-management/authentication" >}}).
   - To access Grafana as a customer, you must have an account in your companies connected identity provider. For further restrictions see the [multi-tenancy guide]({{< relref "/observability-platform/overview/configuration/multi-tenancy" >}}).
...
Learn more about these default organizations and how to create your own in our [multi-tenancy documentation]({{< relref "/observability-platform/overview/configuration/multi-tenancy" >}}).
...
- Learn more about exploring metrics in the [PromQL query reference]({{< relref "/observability-platform/overview/data-management/data-exploration/promql" >}}).
- Learn more about exploring logs and events in the [LogQL query reference]({{< relref "/observability-platform/overview/data-management/data-exploration/logql" >}}).
- Learn more about exploring traces in the [TraceQL query reference]({{< relref "/observability-platform/overview/data-management/data-exploration/traceql" >}}).
- Understand service topology with [service graphs]({{< relref "/observability-platform/overview/data-management/data-exploration/service-graphs/" >}}) generated from trace data.
- For more on creating dashboards or ingesting new data, see our [data ingestion tutorial]({{< relref "/observability-platform/overview/data-management/data-ingestion" >}}) or [multi-tenancy guide]({{< relref "/observability-platform/overview/configuration/multi-tenancy" >}}).
