...
menu:
  principal:
    ...
    identifier: observability-platform-overview-data-management-data-exploration-logql
last_review_date: 2025-07-17
aliases:
  - /overview/observability/data-management/data-exploration/logql/
...
- [Data exploration]({{< relref "/observability-platform/overview/data-management/data-exploration" >}}): how to access Grafana and select the Loki data source
- [Dashboard creation]({{< relref "/observability-platform/overview/dashboard-management/dashboard-creation" >}}): visualize your log queries in dashboards
