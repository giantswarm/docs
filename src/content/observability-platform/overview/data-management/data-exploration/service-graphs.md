...
menu:
  principal:
    ...
    identifier: observability-platform-overview-data-management-data-exploration-service-graphs
...
aliases:
  - /overview/observability/data-management/data-exploration/service-graphs/
---
...
- **[Configure comprehensive tracing]({{< relref "/observability-platform/overview/data-management/data-ingestion/#trace-ingestion" >}})**: Ensure all critical services are instrumented
- **[TraceQL query reference]({{< relref "/observability-platform/overview/data-management/data-exploration/traceql/" >}})**: Use advanced queries to complement service graph insights
- **[Alert on trace-derived metrics]({{< relref "/observability-platform/overview/data-management/data-transformation/alert-on-trace-derived-metrics/" >}})**: Configure alerting based on service graph metrics

- **[Create service dashboards]({{< relref "/observability-platform/overview/dashboard-management/dashboard-creation/" >}})**: Build custom visualizations for service health
