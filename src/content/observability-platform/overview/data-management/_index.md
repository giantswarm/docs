...
menu:
  principal:
    ...
    identifier: observability-platform-overview-data-management
...
aliases:
  - /overview/observability/data-management/
---
...
- **[Metrics ingestion]({{< relref "/observability-platform/overview/data-management/data-ingestion/#metrics-ingestion" >}})**: Collect metrics from applications, infrastructure, and external sources using ServiceMonitors and PodMonitors
- **[Log ingestion]({{< relref "/observability-platform/overview/data-management/data-ingestion/#logs-ingestion" >}})**: Gather logs from applications and infrastructure using PodLogs and automatic collection
- **[Trace ingestion]({{< relref "/observability-platform/overview/data-management/data-ingestion/#trace-ingestion" >}})**: Collect distributed traces from instrumented applications using OpenTelemetry Protocol (OTLP)
- **External data sources**: Push data from external systems via our [Data Import and Export API]({{< relref "/observability-platform/overview/data-management/data-import-export" >}})

### Data exploration

Advanced querying and analysis capabilities:

- **[Interactive exploration]({{< relref "/observability-platform/overview/data-management/data-exploration" >}})**: Use Grafana's Explore feature for ad-hoc analysis with PromQL, LogQL, and TraceQL
- **[Dashboard management]({{< relref "/observability-platform/overview/dashboard-management/dashboard-creation/" >}})**: Build custom visualizations with GitOps workflows or through the Grafana UI
- **Query languages**: [PromQL]({{< relref "/observability-platform/overview/data-management/data-exploration/promql/" >}}) for metrics, [LogQL]({{< relref "/observability-platform/overview/data-management/data-exploration/logql/" >}}) for logs, and [TraceQL]({{< relref "/observability-platform/overview/data-management/data-exploration/traceql/" >}}) for traces with powerful filtering and analysis

### Data transformation

**[Transform and enrich your data]({{< relref "/observability-platform/overview/data-management/data-transformation" >}})** during collection and visualization:

- **[Recording rules]({{< relref "/observability-platform/overview/alert-management/alert-rules#recording-rules" >}})**: Pre-compute expensive PromQL expressions for better performance
...
- **[Data import and export capabilities]({{< relref "/observability-platform/overview/data-management/data-import-export" >}})**: Secure API access for external tools and custom integrations, plus data import from external sources
