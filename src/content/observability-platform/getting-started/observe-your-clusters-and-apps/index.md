...
aliases:
  - /getting-started/observe-your-clusters-and-apps/
  - /getting-started/observability/
  - /getting-started/observability/observe-your-clusters-and-apps/
menu:
  principal:
    parent: observability-platform-getting-started
    identifier: observability-platform-getting-started-observe-your-clusters-and-apps
owner:
...
1. **Running workload cluster**: If you don't have one, [create a workload cluster]({{< relref "/container-platform/getting-started/provision-your-first-workload-cluster" >}}) first
2. **Sample application**: Deploy the [`hello-world` application]({{< relref "/container-platform/getting-started/install-an-application" >}}) or use your own instrumented application
...
⚠️ **Need more advanced ingestion?** See our comprehensive [Data Ingestion guide]({{< relref "/observability-platform/overview/data-management/data-ingestion" >}}) for logs, metrics, and traces.
...
**New to PromQL?** See the [PromQL query reference]({{< relref "/observability-platform/overview/data-management/data-exploration/promql" >}}) for detailed guidance.
...
**Want to learn more?** The [LogQL query reference]({{< relref "/observability-platform/overview/data-management/data-exploration/logql" >}}) covers complex log queries and analysis.
...
**Want to learn more?** The [TraceQL query reference]({{< relref "/observability-platform/overview/data-management/data-exploration/traceql" >}}) covers complex trace queries and analysis.
...
[Download our example dashboard](./dashboard.json) or check our [comprehensive dashboard creation guide]({{< relref "/observability-platform/overview/dashboard-management/dashboard-creation" >}}) for detailed instructions.
...
- **[Set up alerting]({{< relref "/observability-platform/overview/alert-management/" >}})**: Get notified before issues impact users
- **[Learn advanced querying]({{< relref "/observability-platform/overview/data-management/data-exploration/" >}})**: Master PromQL and LogQL for deeper insights
- **[Configure data ingestion]({{< relref "/observability-platform/overview/data-management/data-ingestion/" >}})**: Collect custom logs, metrics, and traces
- **[Explore data transformation]({{< relref "/observability-platform/overview/data-management/data-transformation/" >}})**: Optimize metrics storage and processing
