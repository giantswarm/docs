...
Continue with the [architecture]({{< relref "/overview/agent-platform/architecture" >}}) to see how the gateway is structured, or jump straight to [setting up your AI agent]({{< relref "/getting-started/ai-agent-setup" >}}).
