...
**TLDR**: Workload cluster releases bundle tested components together. We follow Kubernetes versioning - when Kubernetes 1.31 comes out, we release version 31.x.x. We support at least two major versions simultaneously.
