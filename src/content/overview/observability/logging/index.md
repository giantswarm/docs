...
If you want to play with Loki, you should definitely check out our guides explaining [how to access Grafana]({{< relref "/overview/observability/data-management/data-exploration/" >}}) and how to [explore logs with LogQL]({{< relref "/overview/observability/data-management/data-exploration/advanced-logql-tutorial/" >}}).
