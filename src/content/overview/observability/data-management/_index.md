...
### Traces *(Coming soon)*
Distributed traces that track requests across multiple services, helping you understand complex interactions in microservices architectures. Full tracing support is planned for future releases.
...
- **Query languages**: [PromQL]({{< relref "/overview/observability/data-exploration/advanced-promql-tutorial.md" >}}) for metrics and [LogQL](({{< relref "/overview/observability/data-exploration/advanced-logql-tutorial" >}})) for logs with powerful filtering and aggregation
