...
Once the management cluster is ready, you can [explore the platform API]({{< relref "/getting-started/provision-your-first-workload-cluster" >}}) and check all possibilities it offers to manage your workloads.
