...
composing the actual application, carries [App CRs]({{< relref "/use-the-api/management-api/crd/apps.application.giantswarm.io.md" >}})
...
The solitary app installation process has been already well depicted in the [App Platform Overview]({{< relref "/platform-overview/app-platform#what-makes-up-the-app-platform" >}}).
...
The figure below depicts the process briefly. Note however, some parts present in the [App Platform Overview]({{< relref "/platform-overview/app-platform" >}})
...
creating a corresponding [Chart CR]({{< relref "/use-the-api/management-api/crd/charts.application.giantswarm.io.md" >}})
...
Please refer to [App Configuration]({{< relref "/getting-started/app-platform/app-configuration" >}}) to understand how
the user configuration works, and to the [kubectl gs template app]({{< relref "/use-the-api/kubectl-gs/template-app.md" >}})
