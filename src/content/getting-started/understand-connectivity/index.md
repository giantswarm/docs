...
Now that you've learned how to configure your application to communicate with other services, let's dive into how to [observe your application]({{< relref "/getting-started/observe-your-clusters-and-apps" >}}).
