...
description: We recommend OIDC for authentication to the workload cluster Kubernetes API. However, in some scenarios, X.509 key pairs are a viable alternative. Here we explain a Giant Swarms specific way to create such key pairs via the Management API.
weight: 50
menu:
  main:
