...
description: Custom resource definition (CRD) schema reference page for the AzureIdentity resource (azureidentities.aadpodidentity.k8s.io), as part of the Giant Swarm Management API documentation.
