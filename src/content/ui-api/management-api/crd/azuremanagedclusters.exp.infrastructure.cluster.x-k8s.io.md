---
title: AzureManagedCluster CRD schema reference
linkTitle: AzureManagedCluster
technical_name: azuremanagedclusters.exp.infrastructure.cluster.x-k8s.io
description: |
...
layout: crd
aliases:
  - /reference/cp-k8s-api/azuremanagedclusters.exp.infrastructure.cluster.x-k8s.io/
---

# AzureManagedCluster


<p class="crd-description">AzureManagedCluster is the Schema for the azuremanagedclusters API</p>
<dl class="crd-meta">
<dt class="fullname">Full name:</dt>
<dd class="fullname">azuremanagedclusters.exp.infrastructure.cluster.x-k8s.io</dd>
<dt class="groupname">Group:</dt>
<dd class="groupname">exp.infrastructure.cluster.x-k8s.io</dd>
<dt class="singularname">Singular name:</dt>
<dd class="singularname">azuremanagedcluster</dd>
<dt class="pluralname">Plural name:</dt>
<dd class="pluralname">azuremanagedclusters</dd>
...
<div class="property-description">
<p>AzureManagedClusterSpec defines the desired state of AzureManagedCluster</p>
...
<div class="property-description">
<p>AzureManagedClusterStatus defines the observed state of AzureManagedCluster</p>
