...
layout: crd
aliases:
  - /reference/cp-k8s-api/eksconfigtemplates.bootstrap.cluster.x-k8s.io/
---

# EKSConfigTemplate


<p class="crd-description">EKSConfigTemplate is the Schema for the eksconfigtemplates API</p>
<dl class="crd-meta">
<dt class="fullname">Full name:</dt>
<dd class="fullname">eksconfigtemplates.bootstrap.cluster.x-k8s.io</dd>
<dt class="groupname">Group:</dt>
<dd class="groupname">bootstrap.cluster.x-k8s.io</dd>
<dt class="singularname">Singular name:</dt>
<dd class="singularname">eksconfigtemplate</dd>
<dt class="pluralname">Plural name:</dt>
<dd class="pluralname">eksconfigtemplates</dd>
...
<div class="property-header">
<h3 class="property-path" id="v1alpha3-.spec.template.spec.kubeletExtraArgs">.spec.template.spec.kubeletExtraArgs</h3>
</div>
<div class="property-body">
<div class="property-meta">
<span class="property-type">object</span>
