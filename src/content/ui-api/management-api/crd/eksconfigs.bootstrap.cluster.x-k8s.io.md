...
layout: crd
aliases:
  - /reference/cp-k8s-api/eksconfigs.bootstrap.cluster.x-k8s.io/
---

# EKSConfig


<p class="crd-description">EKSConfig is the Schema for the eksconfigs API</p>
<dl class="crd-meta">
<dt class="fullname">Full name:</dt>
<dd class="fullname">eksconfigs.bootstrap.cluster.x-k8s.io</dd>
<dt class="groupname">Group:</dt>
<dd class="groupname">bootstrap.cluster.x-k8s.io</dd>
<dt class="singularname">Singular name:</dt>
<dd class="singularname">eksconfig</dd>
<dt class="pluralname">Plural name:</dt>
<dd class="pluralname">eksconfigs</dd>
...
<div class="property-header">
<h3 class="property-path" id="v1alpha3-.spec.kubeletExtraArgs">.spec.kubeletExtraArgs</h3>
</div>
<div class="property-body">
<div class="property-meta">
<span class="property-type">object</span>
