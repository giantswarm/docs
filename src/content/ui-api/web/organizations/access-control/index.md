...
The access control UI in the web interface provides quick access to a focussed set of RBAC resources, with the goal to make it easy for you to give someone – be it individuals or groups – or service accounts access to resources in an organization's namespace.
