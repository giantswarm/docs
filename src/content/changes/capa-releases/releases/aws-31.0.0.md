...
aliases:
- /changes/workload-cluster-releases-capa/releases/aws-31.0.0/
changes_categories:
- CAPA releases
changes_entry:
  repository: giantswarm/releases
  url: https://github.com/giantswarm/releases/tree/master/capa/v31.0.0
  version: aws-31.0.0
  version_tag: aws-31.0.0
date: '2025-06-13T10:58:54'
description: Release notes for CAPA workload cluster release aws-31.0.0, published
  on 13 June 2025, 10:58.
title: Workload cluster release aws-31.0.0 for CAPA
---
