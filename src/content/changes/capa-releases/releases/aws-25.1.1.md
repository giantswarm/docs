...
aliases:
- /changes/tenant-cluster-releases-capa/releases/capa-aws-25.1.1/
changes_categories:
- CAPA releases
changes_entry:
  repository: giantswarm/releases
  url: https://github.com/giantswarm/releases/tree/master/capa/v25.1.1
  version: aws-25.1.1
  version_tag: aws-25.1.1
date: '2024-09-19T12:00:00'
description: Release notes for capa workload cluster release aws-25.1.1, published
  on 19 September 2024, 12:00.
title: Workload cluster release aws-25.1.1 for CAPA
---
