...
aliases:
- /changes/workload-cluster-releases-capa/releases/aws-32.0.0/
changes_categories:
- CAPA releases
changes_entry:
  repository: giantswarm/releases
  url: https://github.com/giantswarm/releases/tree/master/capa/v32.0.0
  version: aws-32.0.0
  version_tag: aws-32.0.0
date: '2025-09-15T10:31:15'
description: Release notes for CAPA workload cluster release aws-32.0.0, published
  on 15 September 2025, 10:31.
title: Workload cluster release aws-32.0.0 for CAPA
---
