...
aliases:
- /changes/workload-cluster-releases-capa/releases/aws-33.0.0/
changes_categories:
- CAPA releases
changes_entry:
  repository: giantswarm/releases
  url: https://github.com/giantswarm/releases/tree/master/capa/v33.0.0
  version: aws-33.0.0
  version_tag: aws-33.0.0
date: '2025-10-15T15:31:52'
description: Release notes for CAPA workload cluster release aws-33.0.0, published
  on 15 October 2025, 15:31.
title: Workload cluster release aws-33.0.0 for CAPA
---
