...
aliases:
- /changes/workload-cluster-releases-capa/releases/aws-33.1.0/
changes_categories:
- CAPA releases
changes_entry:
  repository: giantswarm/releases
  url: https://github.com/giantswarm/releases/tree/master/capa/v33.1.0
  version: aws-33.1.0
  version_tag: aws-33.1.0
date: '2025-12-03T15:28:03'
description: Release notes for CAPA workload cluster release aws-33.1.0, published
  on 03 December 2025, 15:28.
title: Workload cluster release aws-33.1.0 for CAPA
---
