...
aliases:
- /changes/workload-cluster-releases-capa/releases/aws-36.0.0/
changes_categories:
- CAPA releases
changes_entry:
  repository: giantswarm/releases
  url: https://github.com/giantswarm/releases/tree/master/capa/v36.0.0
  version: aws-36.0.0
  version_tag: aws-36.0.0
date: '2026-09-24T20:18:07'
description: Release notes for CAPA workload cluster release aws-36.0.0, published
  on 24 September 2026, 20:18.
title: Workload cluster release aws-36.0.0 for CAPA
---
