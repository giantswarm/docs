...
aliases:
- /changes/workload-cluster-releases-capa/releases/aws-30.1.0/
changes_categories:
- CAPA releases
changes_entry:
  repository: giantswarm/releases
  url: https://github.com/giantswarm/releases/tree/master/capa/v30.1.0
  version: aws-30.1.0
  version_tag: aws-30.1.0
date: '2025-03-18T12:00:00'
description: Release notes for CAPA workload cluster release aws-30.1.0, published
  on 18 March 2025, 12:00.
title: Workload cluster release aws-30.1.0 for CAPA
---
