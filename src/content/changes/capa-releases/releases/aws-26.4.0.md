...
aliases:
- /changes/tenant-cluster-releases-capa/releases/capa-aws-26.4.0/
changes_categories:
- CAPA releases
changes_entry:
  repository: giantswarm/releases
  url: https://github.com/giantswarm/releases/tree/master/capa/v26.4.0
  version: aws-26.4.0
  version_tag: aws-26.4.0
date: '2025-02-05T12:00:00'
description: Release notes for capa workload cluster release aws-26.4.0, published
  on 05 February 2025, 12:00.
title: Workload cluster release aws-26.4.0 for CAPA
---
