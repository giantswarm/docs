...
aliases:
- /changes/workload-cluster-releases-capa/releases/aws-34.2.0/
changes_categories:
- CAPA releases
changes_entry:
  repository: giantswarm/releases
  url: https://github.com/giantswarm/releases/tree/master/capa/v34.2.0
  version: aws-34.2.0
  version_tag: aws-34.2.0
date: '2026-04-29T09:23:45'
description: Release notes for CAPA workload cluster release aws-34.2.0, published
  on 29 April 2026, 09:23.
title: Workload cluster release aws-34.2.0 for CAPA
---
