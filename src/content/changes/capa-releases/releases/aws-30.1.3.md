...
aliases:
- /changes/workload-cluster-releases-capa/releases/aws-30.1.3/
changes_categories:
- CAPA releases
changes_entry:
  repository: giantswarm/releases
  url: https://github.com/giantswarm/releases/tree/master/capa/v30.1.3
  version: aws-30.1.3
  version_tag: aws-30.1.3
date: '2025-05-27T09:00:00'
description: Release notes for CAPA workload cluster release aws-30.1.3, published
  on 27 May 2025, 09:00.
title: Workload cluster release aws-30.1.3 for CAPA
---
