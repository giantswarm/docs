...
aliases:
- /changes/workload-cluster-releases-capa/releases/aws-25.5.3/
changes_categories:
- CAPA releases
changes_entry:
  repository: giantswarm/releases
  url: https://github.com/giantswarm/releases/tree/master/capa/v25.5.3
  version: aws-25.5.3
  version_tag: aws-25.5.3
date: '2025-03-19T12:00:00'
description: Release notes for CAPA workload cluster release aws-25.5.3, published
  on 19 March 2025, 12:00.
title: Workload cluster release aws-25.5.3 for CAPA
---
