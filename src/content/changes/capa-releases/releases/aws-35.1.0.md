...
aliases:
- /changes/workload-cluster-releases-capa/releases/aws-35.1.0/
changes_categories:
- CAPA releases
changes_entry:
  repository: giantswarm/releases
  url: https://github.com/giantswarm/releases/tree/master/capa/v35.1.0
  version: aws-35.1.0
  version_tag: aws-35.1.0
date: '2026-09-15T15:40:39'
description: Release notes for CAPA workload cluster release aws-35.1.0, published
  on 15 September 2026, 15:40.
title: Workload cluster release aws-35.1.0 for CAPA
---
