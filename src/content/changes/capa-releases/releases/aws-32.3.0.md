...
aliases:
- /changes/workload-cluster-releases-capa/releases/aws-32.3.0/
changes_categories:
- CAPA releases
changes_entry:
  repository: giantswarm/releases
  url: https://github.com/giantswarm/releases/tree/master/capa/v32.3.0
  version: aws-32.3.0
  version_tag: aws-32.3.0
date: '2026-05-13T07:35:59'
description: Release notes for CAPA workload cluster release aws-32.3.0, published
  on 13 May 2026, 07:35.
title: Workload cluster release aws-32.3.0 for CAPA
---
