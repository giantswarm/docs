...
aliases:
- /changes/workload-cluster-releases-capa/releases/aws-32.1.0/
changes_categories:
- CAPA releases
changes_entry:
  repository: giantswarm/releases
  url: https://github.com/giantswarm/releases/tree/master/capa/v32.1.0
  version: aws-32.1.0
  version_tag: aws-32.1.0
date: '2025-11-02T09:58:02'
description: Release notes for CAPA workload cluster release aws-32.1.0, published
  on 02 November 2025, 09:58.
title: Workload cluster release aws-32.1.0 for CAPA
---
