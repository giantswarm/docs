...
aliases:
- /changes/workload-cluster-releases-capa/releases/aws-34.1.0/
changes_categories:
- CAPA releases
changes_entry:
  repository: giantswarm/releases
  url: https://github.com/giantswarm/releases/tree/master/capa/v34.1.0
  version: aws-34.1.0
  version_tag: aws-34.1.0
date: '2026-03-02T15:01:14'
description: Release notes for CAPA workload cluster release aws-34.1.0, published
  on 02 March 2026, 15:01.
title: Workload cluster release aws-34.1.0 for CAPA
---
