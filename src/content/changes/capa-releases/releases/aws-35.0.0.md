...
aliases:
- /changes/workload-cluster-releases-capa/releases/aws-35.0.0/
changes_categories:
- CAPA releases
changes_entry:
  repository: giantswarm/releases
  url: https://github.com/giantswarm/releases/tree/master/capa/v35.0.0
  version: aws-35.0.0
  version_tag: aws-35.0.0
date: '2026-08-22T20:26:37'
description: Release notes for CAPA workload cluster release aws-35.0.0, published
  on 22 August 2026, 20:26.
title: Workload cluster release aws-35.0.0 for CAPA
---
