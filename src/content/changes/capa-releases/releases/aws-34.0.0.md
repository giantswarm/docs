...
aliases:
- /changes/workload-cluster-releases-capa/releases/aws-34.0.0/
changes_categories:
- CAPA releases
changes_entry:
  repository: giantswarm/releases
  url: https://github.com/giantswarm/releases/tree/master/capa/v34.0.0
  version: aws-34.0.0
  version_tag: aws-34.0.0
date: '2026-01-23T12:11:29'
description: Release notes for CAPA workload cluster release aws-34.0.0, published
  on 23 January 2026, 12:11.
