...
aliases:
- /changes/workload-cluster-releases-capa/releases/aws-35.0.1/
changes_categories:
- CAPA releases
changes_entry:
  repository: giantswarm/releases
  url: https://github.com/giantswarm/releases/tree/master/capa/v35.0.1
  version: aws-35.0.1
  version_tag: aws-35.0.1
date: '2026-08-25T15:46:18'
description: Release notes for CAPA workload cluster release aws-35.0.1, published
  on 25 August 2026, 15:46.
title: Workload cluster release aws-35.0.1 for CAPA
---
