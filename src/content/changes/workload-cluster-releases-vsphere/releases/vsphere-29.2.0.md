...
aliases:
- /changes/tenant-cluster-releases-vsphere/releases/vsphere-vsphere-29.2.0/
changes_categories:
...
description: Release notes for VSPHERE workload cluster release vsphere-29.2.0, published
  on 12 December 2024, 12:00.
title: Workload cluster release vsphere-29.2.0 for VSPHERE
---
