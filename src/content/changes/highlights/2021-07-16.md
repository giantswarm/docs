...
In [kubectl gs v1.32.0](https://docs.giantswarm.io/changes/kubectl-gs/kubectl-gs/v1.32.0/), Catalog CRD replaces AppCatalog CRD, enabling organization-wide (rather than 'global'), namespace-scoped, app catalogs. It also adds templating using CAPA (Cluster API Provider AWS) upstream templates for clusters in AWS v20.0.0, in preparation for creating CAPI clusters on Giant Swarm.
