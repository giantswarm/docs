...
- The [linkerd-bundle](https://github.com/giantswarm/linkerd-bundle) version [0.3.0](https://github.com/giantswarm/linkerd-bundle/releases/tag/v0.3.0) updates all Linkerd components to the latest and publish the version to the public catalog. 
