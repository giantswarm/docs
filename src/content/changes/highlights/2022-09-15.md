...
We added the [Documentation](https://docs.giantswarm.io/getting-started/observability/grafana/custom-dashboards/) on how to package custom dashboards together with apps instead of packaging them into a custom repository. 
