...
- `kubectl gs login` now also supports using a service account token for authentication, using the `--token` flag. This facilitates creation of workload cluster client certificates especially in automation.
