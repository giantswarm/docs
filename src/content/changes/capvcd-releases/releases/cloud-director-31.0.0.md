...
aliases:
- /changes/workload-cluster-releases-cloud-director/releases/cloud-director-31.0.0/
changes_categories:
- CAPVCD releases
changes_entry:
  repository: giantswarm/releases
  url: https://github.com/giantswarm/releases/tree/master/cloud-director/v31.0.0
  version: cloud-director-31.0.0
  version_tag: cloud-director-31.0.0
date: '2025-06-12T15:04:32'
description: Release notes for CAPVCD workload cluster release cloud-director-31.0.0,
  published on 12 June 2025, 15:04.
title: Workload cluster release cloud-director-31.0.0 for CAPVCD
---
