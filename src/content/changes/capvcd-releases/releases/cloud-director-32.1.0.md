...
aliases:
- /changes/workload-cluster-releases-cloud-director/releases/cloud-director-32.1.0/
changes_categories:
- CAPVCD releases
changes_entry:
  repository: giantswarm/releases
  url: https://github.com/giantswarm/releases/tree/master/cloud-director/v32.1.0
  version: cloud-director-32.1.0
  version_tag: cloud-director-32.1.0
date: '2025-11-02T09:59:19'
description: Release notes for CAPVCD workload cluster release cloud-director-32.1.0,
  published on 02 November 2025, 09:59.
title: Workload cluster release cloud-director-32.1.0 for CAPVCD
---
