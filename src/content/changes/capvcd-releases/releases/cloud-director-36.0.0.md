...
aliases:
- /changes/workload-cluster-releases-cloud-director/releases/cloud-director-36.0.0/
changes_categories:
- CAPVCD releases
changes_entry:
  repository: giantswarm/releases
  url: https://github.com/giantswarm/releases/tree/master/cloud-director/v36.0.0
  version: cloud-director-36.0.0
  version_tag: cloud-director-36.0.0
date: '2026-09-24T20:19:38'
description: Release notes for CAPVCD workload cluster release cloud-director-36.0.0,
  published on 24 September 2026, 20:19.
title: Workload cluster release cloud-director-36.0.0 for CAPVCD
---
