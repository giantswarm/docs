...
aliases:
- /changes/workload-cluster-releases-cloud-director/releases/cloud-director-35.0.0/
changes_categories:
- CAPVCD releases
changes_entry:
  repository: giantswarm/releases
  url: https://github.com/giantswarm/releases/tree/master/cloud-director/v35.0.0
  version: cloud-director-35.0.0
  version_tag: cloud-director-35.0.0
date: '2026-08-22T20:27:58'
description: Release notes for CAPVCD workload cluster release cloud-director-35.0.0,
  published on 22 August 2026, 20:27.
title: Workload cluster release cloud-director-35.0.0 for CAPVCD
---
