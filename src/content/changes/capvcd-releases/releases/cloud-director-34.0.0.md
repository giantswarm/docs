...
aliases:
- /changes/workload-cluster-releases-cloud-director/releases/cloud-director-34.0.0/
changes_categories:
- CAPVCD releases
changes_entry:
  repository: giantswarm/releases
  url: https://github.com/giantswarm/releases/tree/master/cloud-director/v34.0.0
  version: cloud-director-34.0.0
  version_tag: cloud-director-34.0.0
date: '2026-01-22T09:39:02'
description: Release notes for CAPVCD workload cluster release cloud-director-34.0.0,
  published on 22 January 2026, 09:39.
