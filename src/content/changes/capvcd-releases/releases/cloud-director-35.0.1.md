...
aliases:
- /changes/workload-cluster-releases-cloud-director/releases/cloud-director-35.0.1/
changes_categories:
- CAPVCD releases
changes_entry:
  repository: giantswarm/releases
  url: https://github.com/giantswarm/releases/tree/master/cloud-director/v35.0.1
  version: cloud-director-35.0.1
  version_tag: cloud-director-35.0.1
date: '2026-08-25T15:45:14'
description: Release notes for CAPVCD workload cluster release cloud-director-35.0.1,
  published on 25 August 2026, 15:45.
title: Workload cluster release cloud-director-35.0.1 for CAPVCD
---
