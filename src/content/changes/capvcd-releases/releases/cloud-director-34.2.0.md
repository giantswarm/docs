...
aliases:
- /changes/workload-cluster-releases-cloud-director/releases/cloud-director-34.2.0/
changes_categories:
- CAPVCD releases
changes_entry:
  repository: giantswarm/releases
  url: https://github.com/giantswarm/releases/tree/master/cloud-director/v34.2.0
  version: cloud-director-34.2.0
  version_tag: cloud-director-34.2.0
date: '2026-04-28T16:10:03'
description: Release notes for CAPVCD workload cluster release cloud-director-34.2.0,
  published on 28 April 2026, 16:10.
title: Workload cluster release cloud-director-34.2.0 for CAPVCD
---
