...
aliases:
- /changes/workload-cluster-releases-cloud-director/releases/cloud-director-30.0.0/
changes_categories:
- CAPVCD releases
changes_entry:
...
description: Release notes for CAPVCD workload cluster release cloud-director-30.0.0,
  published on 13 March 2025, 12:00.
title: Workload cluster release cloud-director-30.0.0 for CAPVCD
---
