...
aliases:
- /changes/workload-cluster-releases-cloud-director/releases/cloud-director-29.0.1/
changes_categories:
- CAPVCD releases
changes_entry:
...
description: Release notes for CAPVCD workload cluster release cloud-director-29.0.1,
  published on 06 February 2025, 12:00.
title: Workload cluster release cloud-director-29.0.1 for CAPVCD
---
