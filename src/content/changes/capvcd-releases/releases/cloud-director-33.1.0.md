...
aliases:
- /changes/workload-cluster-releases-cloud-director/releases/cloud-director-33.1.0/
changes_categories:
- CAPVCD releases
changes_entry:
  repository: giantswarm/releases
  url: https://github.com/giantswarm/releases/tree/master/cloud-director/v33.1.0
  version: cloud-director-33.1.0
  version_tag: cloud-director-33.1.0
date: '2025-12-03T15:28:51'
description: Release notes for CAPVCD workload cluster release cloud-director-33.1.0,
  published on 03 December 2025, 15:28.
title: Workload cluster release cloud-director-33.1.0 for CAPVCD
---
