...
aliases:
- /changes/workload-cluster-releases-cloud-director/releases/cloud-director-35.1.1/
changes_categories:
- CAPVCD releases
changes_entry:
  repository: giantswarm/releases
  url: https://github.com/giantswarm/releases/tree/master/cloud-director/v35.1.1
  version: cloud-director-35.1.1
  version_tag: cloud-director-35.1.1
date: '2026-09-24T12:08:16'
description: Release notes for CAPVCD workload cluster release cloud-director-35.1.1,
  published on 24 September 2026, 12:08.
title: Workload cluster release cloud-director-35.1.1 for CAPVCD
---
