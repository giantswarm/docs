...
aliases:
- /changes/workload-cluster-releases-cloud-director/releases/cloud-director-33.0.0/
changes_categories:
- CAPVCD releases
changes_entry:
  repository: giantswarm/releases
  url: https://github.com/giantswarm/releases/tree/master/cloud-director/v33.0.0
  version: cloud-director-33.0.0
  version_tag: cloud-director-33.0.0
date: '2025-10-15T15:31:52'
description: Release notes for CAPVCD workload cluster release cloud-director-33.0.0,
  published on 15 October 2025, 15:31.
title: Workload cluster release cloud-director-33.0.0 for CAPVCD
---
