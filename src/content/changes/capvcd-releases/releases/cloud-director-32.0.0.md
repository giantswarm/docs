...
aliases:
- /changes/workload-cluster-releases-cloud-director/releases/cloud-director-32.0.0/
changes_categories:
- CAPVCD releases
changes_entry:
  repository: giantswarm/releases
  url: https://github.com/giantswarm/releases/tree/master/cloud-director/v32.0.0
  version: cloud-director-32.0.0
  version_tag: cloud-director-32.0.0
date: '2025-09-15T10:32:05'
description: Release notes for CAPVCD workload cluster release cloud-director-32.0.0,
  published on 15 September 2025, 10:32.
title: Workload cluster release cloud-director-32.0.0 for CAPVCD
---
