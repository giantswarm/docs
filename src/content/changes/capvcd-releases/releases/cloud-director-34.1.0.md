...
aliases:
- /changes/workload-cluster-releases-cloud-director/releases/cloud-director-34.1.0/
changes_categories:
- CAPVCD releases
changes_entry:
  repository: giantswarm/releases
  url: https://github.com/giantswarm/releases/tree/master/cloud-director/v34.1.0
  version: cloud-director-34.1.0
  version_tag: cloud-director-34.1.0
date: '2026-03-02T15:01:08'
description: Release notes for CAPVCD workload cluster release cloud-director-34.1.0,
  published on 02 March 2026, 15:01.
title: Workload cluster release cloud-director-34.1.0 for CAPVCD
---
