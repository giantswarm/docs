...
aliases:
- /changes/workload-cluster-releases-cloud-director/releases/cloud-director-29.1.0/
changes_categories:
- CAPVCD releases
changes_entry:
...
description: Release notes for CAPVCD workload cluster release cloud-director-29.1.0,
  published on 25 November 2024, 12:00.
title: Workload cluster release cloud-director-29.1.0 for CAPVCD
---
