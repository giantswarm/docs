...
aliases:
- /changes/tenant-cluster-releases-cloud-director/releases/cloud-director-cloud-director-27.0.0/
changes_categories:
...
description: Release notes for CLOUD-DIRECTOR workload cluster release cloud-director-27.0.0,
  published on 07 November 2024, 12:00.
title: Workload cluster release cloud-director-27.0.0 for CLOUD-DIRECTOR
---
