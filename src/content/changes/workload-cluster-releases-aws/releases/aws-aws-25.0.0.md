...
aliases:
- /changes/tenant-cluster-releases-aws/releases/aws-aws-25.0.0/
changes_categories:
...
description: Release notes for AWS workload cluster release vaws-25.0.0, published
  on 20 June 2024, 18:00.
title: Workload cluster release vaws-25.0.0 for AWS
---
