...
aliases:
- /changes/tenant-cluster-releases-aws/releases/aws-v19.3.4/
changes_categories:
- Workload cluster releases for AWS
changes_entry:
  repository: giantswarm/releases
  url: https://github.com/giantswarm/releases/tree/master/aws/v19.3.4
  version: 19.3.4
  version_tag: v19.3.4
date: '2024-04-29T07:14:42'
description: Release notes for AWS workload cluster release v19.3.4, published on
  29 April 2024, 07:14.
title: Workload cluster release v19.3.4 for AWS
---
