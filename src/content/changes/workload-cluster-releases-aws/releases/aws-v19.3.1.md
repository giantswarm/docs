...
aliases:
- /changes/tenant-cluster-releases-aws/releases/aws-v19.3.1/
changes_categories:
- Workload cluster releases for AWS
changes_entry:
  repository: giantswarm/releases
  url: https://github.com/giantswarm/releases/tree/master/aws/v19.3.1
  version: 19.3.1
  version_tag: v19.3.1
date: '2023-12-14T07:18:20'
description: Release notes for AWS workload cluster release v19.3.1, published on
  14 December 2023, 07:18.
title: Workload cluster release v19.3.1 for AWS
---
