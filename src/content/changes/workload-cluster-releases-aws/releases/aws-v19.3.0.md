...
aliases:
- /changes/tenant-cluster-releases-aws/releases/aws-v19.3.0/
changes_categories:
...
description: Release notes for AWS workload cluster release v19.3.0, published on
  27 November 2023, 07:37.
title: Workload cluster release v19.3.0 for AWS
---
