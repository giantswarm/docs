...
aliases:
- /changes/tenant-cluster-releases-aws/releases/aws-v9.2.1/
changes_categories:
...
description: Release notes for AWS workload cluster release v9.2.1, published on 18
  March 2020, 12:00
title: Workload cluster release v9.2.1 for AWS
---
