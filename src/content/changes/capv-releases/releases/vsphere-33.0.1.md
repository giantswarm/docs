...
aliases:
- /changes/workload-cluster-releases-vsphere/releases/vsphere-33.0.1/
changes_categories:
- CAPV releases
changes_entry:
  repository: giantswarm/releases
  url: https://github.com/giantswarm/releases/tree/master/vsphere/v33.0.1
  version: vsphere-33.0.1
  version_tag: vsphere-33.0.1
date: '2025-10-21T13:29:42'
description: Release notes for CAPV workload cluster release vsphere-33.0.1, published
  on 21 October 2025, 13:29.
title: Workload cluster release vsphere-33.0.1 for CAPV
---
