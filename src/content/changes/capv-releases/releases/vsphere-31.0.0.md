...
aliases:
- /changes/workload-cluster-releases-vsphere/releases/vsphere-31.0.0/
changes_categories:
- CAPV releases
changes_entry:
  repository: giantswarm/releases
  url: https://github.com/giantswarm/releases/tree/master/vsphere/v31.0.0
  version: vsphere-31.0.0
  version_tag: vsphere-31.0.0
date: '2025-06-12T15:03:55'
description: Release notes for CAPV workload cluster release vsphere-31.0.0, published
  on 12 June 2025, 15:03.
title: Workload cluster release vsphere-31.0.0 for CAPV
---
