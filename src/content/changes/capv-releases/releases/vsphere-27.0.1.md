...
aliases:
- /changes/tenant-cluster-releases-capv/releases/capv-vsphere-27.0.1/
changes_categories:
- CAPV releases
changes_entry:
...
description: Release notes for capv workload cluster release vsphere-27.0.1, published
  on 23 October 2024, 12:00.
title: Workload cluster release vsphere-27.0.1 for CAPV
---
