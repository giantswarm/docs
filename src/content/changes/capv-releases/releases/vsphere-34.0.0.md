...
aliases:
- /changes/workload-cluster-releases-vsphere/releases/vsphere-34.0.0/
changes_categories:
- CAPV releases
changes_entry:
  repository: giantswarm/releases
  url: https://github.com/giantswarm/releases/tree/master/vsphere/v34.0.0
  version: vsphere-34.0.0
  version_tag: vsphere-34.0.0
date: '2026-01-22T09:38:42'
description: Release notes for CAPV workload cluster release vsphere-34.0.0, published
  on 22 January 2026, 09:38.
