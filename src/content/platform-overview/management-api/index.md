...
- Managed apps are represented as [`App`]({{< relref "/use-the-api/management-api/crd/apps.application.giantswarm.io.md" >}}) custom resource. Our [app platform introduction]({{< relref "/platform-overview/app-platform" >}}) explains managing app catalogs and apps.
