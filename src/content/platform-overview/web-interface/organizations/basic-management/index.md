...
All you have to do here is to enter the name of the new organization. Please take the [naming conventions and restrictions]({{< relref "/platform-overview/multi-tenancy/index.md#naming-conventions" >}}) into account.
...
- [Grant access to an organization's resources]({{< relref "platform-overview/web-interface/organizations/access-control/index.md" >}})
