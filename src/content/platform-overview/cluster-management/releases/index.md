...
- The [Giant Swarm REST API]({{< relref "/use-the-api/rest-api" >}}) provides an endpoint to list all workload cluster releases with their details.
...
- [Cluster upgrades]({{< relref "/platform-overview/cluster-management/cluster-upgrades" >}}) explains how upgrades work and suggests some best practices to keep a cluster ready to upgrade.
